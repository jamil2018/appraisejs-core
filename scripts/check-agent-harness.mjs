...
const rootHarnessRequiredFiles = [
  ...
  'config/development-harness/agent-profiles.json',
  'config/development-harness/agent-profiles.schema.json',
  'config/development-harness/model-catalog.json',
  'config/development-harness/model-catalog.schema.json',
  'config/development-harness/selection-policy.json',
  'config/development-harness/selection-policy.schema.json',
  'scripts/lib/harness-selection.mjs',
  ...
  'scripts/select-harness-agent.mjs',
  'scripts/replay-harness-selection.mjs',
  'scripts/tests/swarm-routing.test.mjs',
  'scripts/tests/harness-selection.test.mjs',
