...
When(
  ...
  async function (this: CustomWorld, elementName: SelectorName) {
    ...
    if (!selector) {
      throw new Error(
        `Selector ${elementName} not found. Current url: ${this.page.url()}`
      );
    }
    try {
      ...
      throw new Error(
        `Failed to click on the ${elementName} element: ${error}`
      );
    }
  }
);
...
When(
  ...
  async function (this: CustomWorld, elementName: SelectorName) {
    ...
    try {
      ...
      throw new Error(
        `Failed to double click on the ${elementName} element: ${error}`
      );
    }
  }
);
...
When(
  ...
  async function (this: CustomWorld, elementName: SelectorName) {
    ...
    try {
      ...
      throw new Error(
        `Failed to right click on the ${elementName} element: ${error}`
      );
    }
  }
);
