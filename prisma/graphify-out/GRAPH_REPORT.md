...
## Corpus Check
- 96 files from prisma/schema.prisma and migrations
- Verdict: schema-aware graph generated because Graphify AST extraction does not currently produce Prisma/SQL nodes.

## Summary
- 2204 nodes · 5052 edges · 341 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `String` - 906 edges
2. `schema.prisma` - 260 edges
3. `DateTime` - 191 edges
4. `TargetProject` - 188 edges
5. `QualityJourney` - 123 edges
6. `QualityValidationPublication` - 98 edges
7. `Assessment` - 95 edges
8. `QualityPlanRevision` - 89 edges
9. `QualityJourneyScenarioPortfolioRevision` - 85 edges
...
Nodes (39): QualityJourney, QualityJourney.id, QualityJourney.targetProjectId, QualityJourney.rootIdempotencyKey, QualityJourney.rootRequestHash, QualityJourney.stage, QualityJourney.status, QualityJourney.activeCycleId (+more)

### Community 33 - "QualityJourneyArtifact"
Nodes (18): QualityJourneyArtifact, QualityJourneyArtifact.id, QualityJourneyArtifact.identityKey, QualityJourneyArtifact.journeyId, QualityJourneyArtifact.targetProjectId, QualityJourneyArtifact.cycleId, QualityJourneyArtifact.kind, QualityJourneyArtifact.artifactId (+more)
...
Nodes (42): QualityJourneyScenarioPortfolioRevision, QualityJourneyScenarioPortfolioRevision.id, QualityJourneyScenarioPortfolioRevision.journeyId, QualityJourneyScenarioPortfolioRevision.targetProjectId, QualityJourneyScenarioPortfolioRevision.cycleId, QualityJourneyScenarioPortfolioRevision.discoveryRevisionId, QualityJourneyScenarioPortfolioRevision.discoveryCompletionHash, QualityJourneyScenarioPortfolioRevision.predecessorPortfolioRevisionId (+more)

### Community 41 - "QualityJourneyScenarioRevision"
Nodes (16): QualityJourneyScenarioRevision, QualityJourneyScenarioRevision.id, QualityJourneyScenarioRevision.portfolioRevisionId, QualityJourneyScenarioRevision.stableScenarioId, QualityJourneyScenarioRevision.scenarioRevisionId, QualityJourneyScenarioRevision.behavioralIntentJson, QualityJourneyScenarioRevision.behavioralIntentHash, QualityJourneyScenarioRevision.enrichmentJson (+more)

### Community 42 - "QualityJourneyScenarioDecision"
Nodes (16): QualityJourneyScenarioDecision, QualityJourneyScenarioDecision.id, QualityJourneyScenarioDecision.portfolioRevisionId, QualityJourneyScenarioDecision.scenarioRevisionId, QualityJourneyScenarioDecision.decision, QualityJourneyScenarioDecision.feedback, QualityJourneyScenarioDecision.actor, QualityJourneyScenarioDecision.idempotencyKey (+more)

### Community 43 - "QualityJourneyScenarioReviewComment"
...
### Community 44 - "QualityJourneyScenarioDecisionReceipt"
...
### Community 45 - "QualityJourneyRevision"
...
### Community 46 - "QualityJourneyCycle"
...
### Community 47 - "QualityJourneyCommand"
...
### Community 48 - "QualityJourneyEvent"
...
### Community 49 - "QualityJourneyWorkItem"
Nodes (24): QualityJourneyWorkItem, QualityJourneyWorkItem.id, QualityJourneyWorkItem.journeyId, QualityJourneyWorkItem.targetProjectId, QualityJourneyWorkItem.cycleId, QualityJourneyWorkItem.role, QualityJourneyWorkItem.status, QualityJourneyWorkItem.inputHash (+more)

### Community 50 - "QualityJourneyWorkAuthorization"
...
### Community 51 - "QualityJourneyWorkAttempt"
Nodes (40): QualityJourneyWorkAttempt, QualityJourneyWorkAttempt.id, QualityJourneyWorkAttempt.workItemId, QualityJourneyWorkAttempt.attempt, QualityJourneyWorkAttempt.status, QualityJourneyWorkAttempt.leaseId, QualityJourneyWorkAttempt.ownerTokenHash, QualityJourneyWorkAttempt.leaseExpiresAt (+more)

### Community 52 - "QualityJourneyBlocker"
...
### Community 53 - "QualityJourneyArtifactLink"
...
### Community 54 - "AssessmentPreparation"
...
### Community 55 - "AgentPreflightReceipt"
...
### Community 56 - "LifecycleCertificationReceipt"
...
### Community 57 - "ProjectResourceOwnership"
...
### Community 58 - "ProjectResourceImport"
...
### Community 62 - "RuntimeCapsuleExecutionAttempt"
...
### Community 63 - "RuntimeCapsuleExecutionAttemptState"
...
### Community 64 - "RuntimeCapsuleBlob"
...
### Community 65 - "RuntimeCapsuleBlobReference"
...
### Community 66 - "RuntimeCapsuleIntegrityState"
...
### Community 67 - "RuntimeCapsuleLease"
...
### Community 73 - "ConflictResolution"
...
### Community 79 - "ReportScenarioTag"
...
### Community 86 - "QualityPlanRevision"
...
### Community 87 - "RequirementAnalysisRevision"
...
### Community 88 - "RequirementSnapshot"
...
### Community 90 - "QualityObligationRevision"
...
### Community 91 - "ValidationDesignRevision"
...
### Community 92 - "ValidationVersion"
...
### Community 93 - "QualityValidationGeneration"
...
### Community 94 - "QualityValidationPublication"
...
### Community 95 - "QualityValidationPublicationCommandReceipt"
...
### Community 96 - "QualityValidationExtensionReview"
...
### Community 97 - "ObligationValidationVersion"
...
### Community 98 - "EvaluationSubjectRevision"
...
### Community 99 - "RemoteEvaluationScopeBinding"
...
### Community 100 - "RemoteEvaluationScopePartitionManifest"
...
### Community 101 - "RemoteEvaluationScopePartition"
...
### Community 102 - "RemoteEvaluationScopeIssuance"
...
### Community 104 - "ExecutionConsent"
...
### Community 106 - "AssessmentExecutionRequest"
...
### Community 107 - "AssessmentExecutionCredentialBinding"
...
### Community 108 - "CredentialAuthorizationUiSession"
...
### Community 109 - "AssessmentExecutionAuthorizationGrant"
...
### Community 110 - "AssessmentRunBinding"
...
### Community 111 - "AssessmentRunPublicationCheckpoint"
...
### Community 113 - "AssessmentDecision"
...
### Community 114 - "AssessmentFinding"
...
### Community 115 - "AssessmentFindingEvidenceReceipt"
...
### Community 116 - "RequirementDriftReport"
...
### Community 120 - "ExecutionConsentStatus"
...
### Community 123 - "TestRunTestCaseStatus"
...
### Community 126 - "TestRunEvidenceHealth"
...
### Community 131 - "StepType"
Nodes (3): StepType, StepType.ACTION, StepType.ASSERTION

### Community 132 - "StepParameterType"
...
### Community 133 - "StepParameterValueType"
...
### Community 141 - "QualityPlanRevisionStatus"
...
### Community 142 - "RequirementAnalysisRevisionStatus"
...
### Community 143 - "RequirementAnalysisDecision"
...
### Community 144 - "RequirementSnapshotKind"
...
### Community 145 - "RequirementQueryStatus"
...
### Community 148 - "ValidationDesignRevisionStatus"
...
### Community 149 - "ValidationDesignDecision"
...
### Community 150 - "ValidationReuseOutcome"
...
### Community 151 - "EvaluationSubjectKind"
...
### Community 152 - "AssessmentStatus"
...
### Community 153 - "AssessmentRunStatus"
...
### Community 154 - "RequirementAlignmentStatus"
...
### Community 156 - "ObligationFindingOutcome"
...
### Community 157 - "FindingReviewStatus"
...
### Community 158 - "FailureAttribution"
...
### Community 159 - "AssessmentDecisionOutcome"
...
### Community 160 - "RequirementDriftStatus"
...
### Community 161 - "QualityJourneyStage"
...
### Community 162 - "QualityJourneyRole"
...
### Community 163 - "QualityJourneyWorkItemStatus"
...
### Community 165 - "DateTime"
Nodes (1): DateTime

### Community 166 - "Int"
Nodes (1): Int

### Community 167 - "Boolean"
Nodes (1): Boolean

### Community 168 - "Float"
Nodes (1): Float

### Community 169 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 170 - "TemplateStep"
Nodes (1): TemplateStep

### Community 171 - "TemplateStepGroup"
Nodes (1): TemplateStepGroup

### Community 172 - "TemplateStepParameter"
Nodes (1): TemplateStepParameter

### Community 173 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 174 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 175 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 176 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 177 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 178 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 179 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 180 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 181 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 182 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 183 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 184 - "new_Tag"
Nodes (1): new_Tag

### Community 185 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 186 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 187 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 188 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 189 - "new_TestRun"
Nodes (1): new_TestRun

### Community 190 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 191 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 192 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 193 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 194 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 195 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 196 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 197 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 198 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 199 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 200 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 201 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 202 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 203 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 204 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 205 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 206 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 207 - "PlanProjection"
Nodes (1): PlanProjection

### Community 208 - "PlanRevision"
Nodes (1): PlanRevision

### Community 209 - "PlanSyncIssue"
Nodes (1): PlanSyncIssue

### Community 210 - "PlanTaskProjection"
Nodes (1): PlanTaskProjection

### Community 211 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 212 - "PlanEvent"
Nodes (1): PlanEvent

### Community 213 - "PlanPersonalLayout"
Nodes (1): PlanPersonalLayout

### Community 214 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 215 - "AppraiseProjectIdentity"
Nodes (1): AppraiseProjectIdentity

### Community 216 - "PlanCoordinatorLease"
Nodes (1): PlanCoordinatorLease

### Community 217 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 218 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 219 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 220 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 221 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 222 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 223 - "ProviderAdapterRegistration"
Nodes (1): ProviderAdapterRegistration

### Community 224 - "ProviderArtifactSnapshot"
Nodes (1): ProviderArtifactSnapshot

### Community 225 - "ProviderPermissionDecision"
Nodes (1): ProviderPermissionDecision

### Community 226 - "ProviderRunEvent"
Nodes (1): ProviderRunEvent

### Community 227 - "ProviderWorkflowRun"
Nodes (1): ProviderWorkflowRun

### Community 228 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 229 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 230 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 231 - "StepBlock"
Nodes (1): StepBlock

### Community 232 - "StepBlockStep"
Nodes (1): StepBlockStep

### Community 233 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 234 - "BaselineAttempt"
Nodes (1): BaselineAttempt

### Community 235 - "BaselineAttemptEvent"
Nodes (1): BaselineAttemptEvent

### Community 236 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 237 - "DelegatedAuthorizationNonce"
Nodes (1): DelegatedAuthorizationNonce

### Community 238 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 239 - "DelegatedValidationAstSubmission"
Nodes (1): DelegatedValidationAstSubmission

### Community 240 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 241 - "ValidationAstPublishOperation"
Nodes (1): ValidationAstPublishOperation

### Community 242 - "ValidationExtensionReview"
Nodes (1): ValidationExtensionReview

### Community 243 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 244 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 245 - "20260712020000_add_test_run_preparation_key"
Nodes (1): 20260712020000_add_test_run_preparation_key

### Community 246 - "20260712180000_add_repository_exports"
Nodes (1): 20260712180000_add_repository_exports

### Community 247 - "RepositoryExportJob"
Nodes (1): RepositoryExportJob

### Community 248 - "RepositoryExportReceipt"
Nodes (1): RepositoryExportReceipt

### Community 249 - "20260713143000_add_project_resource_ownership"
Nodes (1): 20260713143000_add_project_resource_ownership

### Community 250 - "20260713153000_add_validation_resource_proposals"
Nodes (1): 20260713153000_add_validation_resource_proposals

### Community 251 - "ValidationResourceProposal"
Nodes (1): ValidationResourceProposal

### Community 252 - "20260713163000_normalize_managed_validation_vocabulary"
Nodes (1): 20260713163000_normalize_managed_validation_vocabulary

### Community 253 - "20260713173000_add_named_plan_hashes"
Nodes (1): 20260713173000_add_named_plan_hashes

### Community 254 - "20260713183000_add_delegated_coordinator_receipts"
Nodes (1): 20260713183000_add_delegated_coordinator_receipts

### Community 255 - "DelegatedCoordinatorConsumption"
Nodes (1): DelegatedCoordinatorConsumption

### Community 256 - "DelegatedCoordinatorReceipt"
Nodes (1): DelegatedCoordinatorReceipt

### Community 257 - "20260713200000_stage_complete_project_ownership"
Nodes (1): 20260713200000_stage_complete_project_ownership

### Community 258 - "20260713210000_add_target_project_description"
Nodes (1): 20260713210000_add_target_project_description

### Community 259 - "20260713211000_scope_test_run_preparation_key"
Nodes (1): 20260713211000_scope_test_run_preparation_key

### Community 260 - "20260714000000_make_template_library_shared"
Nodes (1): 20260714000000_make_template_library_shared

### Community 261 - "20260714143000_add_validation_review_state_receipt"
Nodes (1): 20260714143000_add_validation_review_state_receipt

### Community 262 - "20260714160500_scope_environment_names_to_project"
Nodes (1): 20260714160500_scope_environment_names_to_project

### Community 263 - "20260716190000_replace_environment_password_with_reference"
Nodes (1): 20260716190000_replace_environment_password_with_reference

### Community 264 - "new_Environment"
Nodes (1): new_Environment

### Community 265 - "20260716210000_add_measured_test_run_pagination_index"
Nodes (1): 20260716210000_add_measured_test_run_pagination_index

### Community 266 - "20260718110000_add_agent_preflight_receipts"
Nodes (1): 20260718110000_add_agent_preflight_receipts

### Community 267 - "20260718160000_add_plan_observability"
Nodes (1): 20260718160000_add_plan_observability

### Community 268 - "PlanOperationMetric"
Nodes (1): PlanOperationMetric

### Community 269 - "20260718193000_add_environment_identity_expectation"
Nodes (1): 20260718193000_add_environment_identity_expectation

### Community 270 - "20260720010000_add_canonical_operation_mappings"
Nodes (1): 20260720010000_add_canonical_operation_mappings

### Community 271 - "20260722013000_scope_locator_group_names_to_project"
Nodes (1): 20260722013000_scope_locator_group_names_to_project

### Community 272 - "20260722190000_add_step_definition_registry"
Nodes (1): 20260722190000_add_step_definition_registry

### Community 273 - "StepCompatibilityReference"
Nodes (1): StepCompatibilityReference

### Community 274 - "20260722223000_add_step_definition_reviewed_extensions"
Nodes (1): 20260722223000_add_step_definition_reviewed_extensions

### Community 275 - "20260725190000_add_step_block_migration_ledger"
Nodes (1): 20260725190000_add_step_block_migration_ledger

### Community 276 - "StepBlockMigrationLedger"
Nodes (1): StepBlockMigrationLedger

### Community 277 - "_LegacyCompositionDefinition"
Nodes (1): _LegacyCompositionDefinition

### Community 278 - "20260725193000_make_validation_projection_template_step_optional"
Nodes (1): 20260725193000_make_validation_projection_template_step_optional

### Community 279 - "new_TestCaseStep"
Nodes (1): new_TestCaseStep

### Community 280 - "20260725194500_cut_over_authored_steps_to_step_invocations"
Nodes (1): 20260725194500_cut_over_authored_steps_to_step_invocations

### Community 281 - "IF"
Nodes (1): IF

### Community 282 - "20260725200000_remove_legacy_step_authority"
Nodes (1): 20260725200000_remove_legacy_step_authority

### Community 283 - "20260725201000_add_step_definition_telemetry"
Nodes (1): 20260725201000_add_step_definition_telemetry

### Community 284 - "20260725202000_add_step_definition_reuse_justification"
Nodes (1): 20260725202000_add_step_definition_reuse_justification

### Community 285 - "20260725203000_add_step_definition_review_receipts"
Nodes (1): 20260725203000_add_step_definition_review_receipts

### Community 286 - "20260725204000_harden_step_definition_evidence_and_telemetry"
Nodes (1): 20260725204000_harden_step_definition_evidence_and_telemetry

### Community 287 - "20260725205000_add_reviewed_extension_revocation"
Nodes (1): 20260725205000_add_reviewed_extension_revocation

### Community 288 - "20260725206000_add_step_definition_search_receipts"
Nodes (1): 20260725206000_add_step_definition_search_receipts

### Community 289 - "20260803000000_add_quality_design_assessment"
Nodes (1): 20260803000000_add_quality_design_assessment

### Community 290 - "20260805200000_allow_multiple_validation_node_decisions"
Nodes (1): 20260805200000_allow_multiple_validation_node_decisions

### Community 291 - "20260807110000_add_workflow_reliability_receipts"
Nodes (1): 20260807110000_add_workflow_reliability_receipts

### Community 292 - "CoordinatorFailureReceipt"
Nodes (1): CoordinatorFailureReceipt

### Community 293 - "CoordinatorOperationReceipt"
Nodes (1): CoordinatorOperationReceipt

### Community 294 - "ValidationDecisionReceipt"
Nodes (1): ValidationDecisionReceipt

### Community 295 - "ValidationNodePublication"
Nodes (1): ValidationNodePublication

### Community 296 - "__WorkflowReliabilityMigrationGuard"
Nodes (1): __WorkflowReliabilityMigrationGuard

### Community 297 - "20260810000000_add_assessment_execution_cutover"
Nodes (1): 20260810000000_add_assessment_execution_cutover

### Community 298 - "new_RuntimeCapsule"
Nodes (1): new_RuntimeCapsule

### Community 299 - "20260812000000_add_assessment_preparation"
Nodes (1): 20260812000000_add_assessment_preparation

### Community 300 - "20260814090000_add_test_run_blocked_result"
Nodes (1): 20260814090000_add_test_run_blocked_result

### Community 301 - "20260815090000_add_assessment_successor_lineage"
Nodes (1): 20260815090000_add_assessment_successor_lineage

### Community 302 - "new_Assessment"
Nodes (1): new_Assessment

### Community 303 - "20260816093000_add_credential_execution_authorization"
Nodes (1): 20260816093000_add_credential_execution_authorization

### Community 304 - "new_AssessmentRun"
Nodes (1): new_AssessmentRun

### Community 305 - "20260819090000_canonical_capsule_target_cutover"
Nodes (1): 20260819090000_canonical_capsule_target_cutover

### Community 306 - "20260822090000_remote_evaluation_scope_v1"
Nodes (1): 20260822090000_remote_evaluation_scope_v1

### Community 307 - "new_EvaluationSubjectRevision"
Nodes (1): new_EvaluationSubjectRevision

### Community 308 - "20260822100000_unified_assessment_preflight_v2"
Nodes (1): 20260822100000_unified_assessment_preflight_v2

### Community 309 - "_appraise_v2_preflight_guard"
Nodes (1): _appraise_v2_preflight_guard

### Community 310 - "20260824120000_quality_validation_generation_v3"
Nodes (1): 20260824120000_quality_validation_generation_v3

### Community 311 - "_qvg_binding_copy_guard"
Nodes (1): _qvg_binding_copy_guard

### Community 312 - "_qvg_copy_guard"
Nodes (1): _qvg_copy_guard

### Community 313 - "_qvg_evidence_copy_guard"
Nodes (1): _qvg_evidence_copy_guard

### Community 314 - "_qvg_fk_guard"
Nodes (1): _qvg_fk_guard

### Community 315 - "_qvg_guard"
Nodes (1): _qvg_guard

### Community 316 - "_qvg_legacy_binding_snapshot"
Nodes (1): _qvg_legacy_binding_snapshot

### Community 317 - "_qvg_legacy_evidence_snapshot"
Nodes (1): _qvg_legacy_evidence_snapshot

### Community 318 - "_qvg_legacy_publication_snapshot"
Nodes (1): _qvg_legacy_publication_snapshot

### Community 319 - "_qvg_legacy_validation_snapshot"
Nodes (1): _qvg_legacy_validation_snapshot

### Community 320 - "_qvg_validation_copy_guard"
Nodes (1): _qvg_validation_copy_guard

### Community 321 - "new_AssessmentRunBinding"
Nodes (1): new_AssessmentRunBinding

### Community 322 - "new_EvidenceReceipt"
Nodes (1): new_EvidenceReceipt

### Community 323 - "new_QualityValidationExtensionReview"
Nodes (1): new_QualityValidationExtensionReview

### Community 324 - "new_QualityValidationPublication"
Nodes (1): new_QualityValidationPublication

### Community 325 - "new_ValidationVersion"
Nodes (1): new_ValidationVersion

### Community 326 - "20260824130000_remote_scope_audit_rows_insert_only"
Nodes (1): 20260824130000_remote_scope_audit_rows_insert_only

### Community 327 - "20260824140000_assessment_binding_integrity_rejection"
Nodes (1): 20260824140000_assessment_binding_integrity_rejection

### Community 328 - "20260825090000_add_remote_scope_partition_manifest"
Nodes (1): 20260825090000_add_remote_scope_partition_manifest

### Community 329 - "20260826000000_add_quality_operating_system_foundation"
Nodes (1): 20260826000000_add_quality_operating_system_foundation

### Community 330 - "_quality_os_fk_guard"
Nodes (1): _quality_os_fk_guard

### Community 331 - "20260828140000_add_quality_journey_phase_1"
Nodes (1): 20260828140000_add_quality_journey_phase_1

### Community 332 - "20260828150000_add_quality_journey_factory_lineage"
Nodes (1): 20260828150000_add_quality_journey_factory_lineage

### Community 333 - "20260828160000_complete_quality_journey_factory_phase_2"
Nodes (1): 20260828160000_complete_quality_journey_factory_phase_2

### Community 334 - "20260901090000_add_quality_journey_analysis_control_plane"
Nodes (1): 20260901090000_add_quality_journey_analysis_control_plane

### Community 335 - "20260901110000_enforce_quality_journey_analysis_answer_heads"
Nodes (1): 20260901110000_enforce_quality_journey_analysis_answer_heads

### Community 336 - "20260903120000_add_quality_journey_discovery_control_plane"
Nodes (1): 20260903120000_add_quality_journey_discovery_control_plane

### Community 337 - "20260904090000_add_quality_journey_scenario_review"
Nodes (1): 20260904090000_add_quality_journey_scenario_review

### Community 338 - "20260904100000_add_scenario_comment_disposition_receipts"
Nodes (1): 20260904100000_add_scenario_comment_disposition_receipts

### Community 339 - "20260904110000_harden_scenario_portfolio_authority"
Nodes (1): 20260904110000_harden_scenario_portfolio_authority

### Community 340 - "20260904120000_scenario_receipt_and_immutability"
