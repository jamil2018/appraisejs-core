...
Nodes (21): TestRun, TestRun.id, TestRun.name, TestRun.runId, TestRun.startedAt, TestRun.completedAt, TestRun.status, TestRun.result (+more)

### Community 22 - "PlanProjection"
Nodes (26): PlanProjection, PlanProjection.id, PlanProjection.planId, PlanProjection.revision, PlanProjection.lifecycle, PlanProjection.goal, PlanProjection.description, PlanProjection.sourceHash (+more)

### Community 23 - "PlanTaskProjection"
...
### Community 27 - "AppraiseProjectIdentity"
...
### Community 28 - "PlanCoordinatorLease"
...
### Community 29 - "PlanPersonalLayout"
...
### Community 33 - "ConflictResolution"
...
### Community 39 - "ReportScenarioTag"
...
### Community 47 - "TestRunTestCaseStatus"
...
### Community 56 - "StepParameterValueType"
...
### Community 67 - "Boolean"
Nodes (1): Boolean

### Community 68 - "Float"
Nodes (1): Float

### Community 69 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 70 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 71 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 72 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 73 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 74 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 75 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 76 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 77 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 78 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 79 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 80 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 81 - "new_Tag"
Nodes (1): new_Tag

### Community 82 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 83 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 84 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 85 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 86 - "new_TestRun"
Nodes (1): new_TestRun

### Community 87 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 88 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 89 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 90 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 91 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 92 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 93 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 94 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 95 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 96 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 97 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 98 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 99 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 100 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 101 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 102 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 103 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 104 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 105 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 106 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 107 - "20260613015000_add_plan_description"
