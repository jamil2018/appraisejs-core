...
## Summary
- 1580 nodes · 3539 edges · 240 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `String` - 654 edges
2. `schema.prisma` - 209 edges
3. `TargetProject` - 167 edges
4. `DateTime` - 160 edges
5. `PlanProjection` - 106 edges
6. `TestRun` - 73 edges
7. `ValidationAstPublishOperation` - 67 edges
...
Nodes (40): PlanProjection, PlanProjection.id, PlanProjection.planId, PlanProjection.slug, PlanProjection.legacyPlanId, PlanProjection.revision, PlanProjection.lifecycle, PlanProjection.goal (+more)

### Community 32 - "BaselineAttempt"
Nodes (16): BaselineAttempt, BaselineAttempt.id, BaselineAttempt.planProjectionId, BaselineAttempt.validationId, BaselineAttempt.validationRevision, BaselineAttempt.validationHash, BaselineAttempt.browser, BaselineAttempt.environment (+more)
...
Nodes (42): TargetProject, TargetProject.id, TargetProject.canonicalPath, TargetProject.displayName, TargetProject.description, TargetProject.packageName, TargetProject.packageManager, TargetProject.packageJson (+more)
...
Nodes (20): PlanOperationMetric, PlanOperationMetric.id, PlanOperationMetric.planProjectionId, PlanOperationMetric.phase, PlanOperationMetric.operation, PlanOperationMetric.statusCode, PlanOperationMetric.durationMs, PlanOperationMetric.waitMs (+more)
...
Nodes (19): RuntimeCapsule, RuntimeCapsule.id, RuntimeCapsule.targetProjectId, RuntimeCapsule.testRunId, RuntimeCapsule.validationHash, RuntimeCapsule.publicationId, RuntimeCapsule.capsuleHash, RuntimeCapsule.manifestHash (+more)
...
Nodes (20): PlanEvent, PlanEvent.id, PlanEvent.planProjectionId, PlanEvent.publishOperationId, PlanEvent.validationId, PlanEvent.operationEventKey, PlanEvent.sequence, PlanEvent.type (+more)

### Community 63 - "ValidationNodePublication"
Nodes (18): ValidationNodePublication, ValidationNodePublication.id, ValidationNodePublication.planId, ValidationNodePublication.targetProjectId, ValidationNodePublication.validationId, ValidationNodePublication.contentHash, ValidationNodePublication.publishOperationId, ValidationNodePublication.operationHash (+more)

### Community 64 - "ValidationDecisionReceipt"
Nodes (10): ValidationDecisionReceipt, ValidationDecisionReceipt.id, ValidationDecisionReceipt.publicationId, ValidationDecisionReceipt.decision, ValidationDecisionReceipt.decidedBy, ValidationDecisionReceipt.decidedAt, ValidationDecisionReceipt.requestHash, ValidationDecisionReceipt.idempotencyKey (+more)

### Community 65 - "CoordinatorFailureReceipt"
Nodes (17): CoordinatorFailureReceipt, CoordinatorFailureReceipt.id, CoordinatorFailureReceipt.schemaVersion, CoordinatorFailureReceipt.errorId, CoordinatorFailureReceipt.occurredAt, CoordinatorFailureReceipt.classification, CoordinatorFailureReceipt.code, CoordinatorFailureReceipt.httpStatus (+more)

### Community 66 - "CoordinatorOperationReceipt"
Nodes (16): CoordinatorOperationReceipt, CoordinatorOperationReceipt.id, CoordinatorOperationReceipt.operationName, CoordinatorOperationReceipt.scopeKey, CoordinatorOperationReceipt.idempotencyKey, CoordinatorOperationReceipt.requestHash, CoordinatorOperationReceipt.requestJson, CoordinatorOperationReceipt.resultHash (+more)

### Community 67 - "AppraiseProjectIdentity"
...
### Community 68 - "DelegatedAuthorizationNonce"
...
### Community 69 - "DelegatedCoordinatorReceipt"
...
### Community 70 - "DelegatedCoordinatorConsumption"
...
### Community 71 - "DelegatedValidationAstSubmission"
...
### Community 74 - "PlanCoordinatorLease"
...
### Community 75 - "PlanPersonalLayout"
...
### Community 77 - "EnvironmentCredentialState"
...
### Community 80 - "ConflictResolution"
...
### Community 86 - "ReportScenarioTag"
...
### Community 93 - "QualityPlanRevision"
...
### Community 94 - "RequirementSnapshot"
...
### Community 96 - "QualityObligationRevision"
...
### Community 98 - "ObligationValidationVersion"
...
### Community 99 - "EvaluationSubjectRevision"
...
### Community 102 - "AssessmentDecision"
...
### Community 103 - "RequirementDriftReport"
...
### Community 106 - "TestRunTestCaseStatus"
...
### Community 114 - "StepType"
Nodes (3): StepType, StepType.ACTION, StepType.ASSERTION

### Community 115 - "StepParameterType"
...
### Community 116 - "StepParameterValueType"
...
### Community 124 - "QualityPlanRevisionStatus"
...
### Community 125 - "RequirementSnapshotKind"
...
### Community 126 - "RequirementQueryStatus"
...
### Community 129 - "ValidationReuseOutcome"
...
### Community 134 - "AssessmentDecisionOutcome"
...
### Community 135 - "RequirementDriftStatus"
...
### Community 139 - "Boolean"
Nodes (1): Boolean

### Community 140 - "Float"
Nodes (1): Float

### Community 141 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 142 - "TemplateStep"
Nodes (1): TemplateStep

### Community 143 - "TemplateStepGroup"
Nodes (1): TemplateStepGroup

### Community 144 - "TemplateStepParameter"
Nodes (1): TemplateStepParameter

### Community 145 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 146 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 147 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 148 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 149 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 150 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 151 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 152 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 153 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 154 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 155 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 156 - "new_Tag"
Nodes (1): new_Tag

### Community 157 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 158 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 159 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 160 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 161 - "new_TestRun"
Nodes (1): new_TestRun

### Community 162 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 163 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 164 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 165 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 166 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 167 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 168 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 169 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 170 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 171 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 172 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 173 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 174 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 175 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 176 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 177 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 178 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 179 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 180 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 181 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 182 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 183 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 184 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 185 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 186 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 187 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 188 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 189 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 190 - "StepBlock"
Nodes (1): StepBlock

### Community 191 - "StepBlockStep"
Nodes (1): StepBlockStep

### Community 192 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 193 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 194 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 195 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 196 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 197 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 198 - "20260712020000_add_test_run_preparation_key"
Nodes (1): 20260712020000_add_test_run_preparation_key

### Community 199 - "20260712180000_add_repository_exports"
Nodes (1): 20260712180000_add_repository_exports

### Community 200 - "20260713143000_add_project_resource_ownership"
Nodes (1): 20260713143000_add_project_resource_ownership

### Community 201 - "20260713153000_add_validation_resource_proposals"
Nodes (1): 20260713153000_add_validation_resource_proposals

### Community 202 - "20260713163000_normalize_managed_validation_vocabulary"
Nodes (1): 20260713163000_normalize_managed_validation_vocabulary

### Community 203 - "20260713173000_add_named_plan_hashes"
Nodes (1): 20260713173000_add_named_plan_hashes

### Community 204 - "20260713183000_add_delegated_coordinator_receipts"
Nodes (1): 20260713183000_add_delegated_coordinator_receipts

### Community 205 - "20260713200000_stage_complete_project_ownership"
Nodes (1): 20260713200000_stage_complete_project_ownership

### Community 206 - "20260713210000_add_target_project_description"
Nodes (1): 20260713210000_add_target_project_description

### Community 207 - "20260713211000_scope_test_run_preparation_key"
Nodes (1): 20260713211000_scope_test_run_preparation_key

### Community 208 - "20260714000000_make_template_library_shared"
Nodes (1): 20260714000000_make_template_library_shared

### Community 209 - "20260714143000_add_validation_review_state_receipt"
Nodes (1): 20260714143000_add_validation_review_state_receipt

### Community 210 - "20260714160500_scope_environment_names_to_project"
Nodes (1): 20260714160500_scope_environment_names_to_project

### Community 211 - "20260716190000_replace_environment_password_with_reference"
Nodes (1): 20260716190000_replace_environment_password_with_reference

### Community 212 - "new_Environment"
Nodes (1): new_Environment

### Community 213 - "20260716210000_add_measured_test_run_pagination_index"
Nodes (1): 20260716210000_add_measured_test_run_pagination_index

### Community 214 - "20260718110000_add_agent_preflight_receipts"
Nodes (1): 20260718110000_add_agent_preflight_receipts

### Community 215 - "20260718160000_add_plan_observability"
...
### Community 239 - "__WorkflowReliabilityMigrationGuard"
