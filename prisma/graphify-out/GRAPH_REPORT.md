...
## Corpus Check
- 39 files from prisma/schema.prisma and migrations
- Verdict: schema-aware graph generated because Graphify AST extraction does not currently produce Prisma/SQL nodes.

## Summary
- 928 nodes · 2058 edges · 144 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `String` - 361 edges
2. `schema.prisma` - 125 edges
3. `DateTime` - 110 edges
4. `PlanProjection` - 82 edges
5. `TestRun` - 72 edges
6. `ProviderWorkflowRun` - 56 edges
7. `ValidationAstPublishOperation` - 54 edges
8. `TargetProject` - 50 edges
9. `TestCase` - 46 edges
...
Nodes (18): TargetProject, TargetProject.id, TargetProject.canonicalPath, TargetProject.displayName, TargetProject.packageName, TargetProject.packageManager, TargetProject.packageJson, TargetProject.fingerprint (+more)

### Community 28 - "RuntimeCapsule"
...
### Community 29 - "RuntimeCapsuleExecutionAttempt"
...
### Community 30 - "RuntimeCapsuleExecutionAttemptState"
...
### Community 31 - "RuntimeCapsuleBlob"
...
### Community 32 - "RuntimeCapsuleBlobReference"
...
### Community 33 - "RuntimeCapsuleIntegrityState"
...
### Community 34 - "RuntimeCapsuleLease"
...
### Community 35 - "ProviderAdapterRegistration"
...
### Community 36 - "ProviderWorkflowRun"
...
### Community 38 - "ProviderPermissionDecision"
...
### Community 39 - "ProviderArtifactSnapshot"
...
### Community 40 - "PlanTaskProjection"
...
### Community 44 - "AppraiseProjectIdentity"
...
### Community 45 - "DelegatedAuthorizationNonce"
...
### Community 46 - "DelegatedValidationAstSubmission"
...
### Community 49 - "PlanCoordinatorLease"
...
### Community 50 - "PlanPersonalLayout"
...
### Community 54 - "ConflictResolution"
...
### Community 60 - "ReportScenarioTag"
...
### Community 68 - "TestRunTestCaseStatus"
...
### Community 78 - "StepParameterValueType"
...
### Community 89 - "Boolean"
Nodes (1): Boolean

### Community 90 - "Float"
Nodes (1): Float

### Community 91 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 92 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 93 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 94 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 95 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 96 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 97 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 98 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 99 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 100 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 101 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 102 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 103 - "new_Tag"
Nodes (1): new_Tag

### Community 104 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 105 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 106 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 107 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 108 - "new_TestRun"
Nodes (1): new_TestRun

### Community 109 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 110 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 111 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 112 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 113 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 114 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 115 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 116 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 117 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 118 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 119 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 120 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 121 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 122 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 123 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 124 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 125 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 126 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 127 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 128 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 129 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 130 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 131 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 132 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 133 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 134 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 135 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 136 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 137 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 138 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 139 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 140 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 141 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 142 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 143 - "20260712020000_add_test_run_preparation_key"
