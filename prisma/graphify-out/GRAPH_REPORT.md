...
## Corpus Check
- 63 files from prisma/schema.prisma and migrations
- Verdict: schema-aware graph generated because Graphify AST extraction does not currently produce Prisma/SQL nodes.

## Summary
- 1259 nodes · 2810 edges · 199 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `String` - 520 edges
2. `schema.prisma` - 172 edges
3. `TargetProject` - 152 edges
...
Nodes (14): StepDefinitionDraft, StepDefinitionDraft.id, StepDefinitionDraft.proposedStepId, StepDefinitionDraft.proposedVersion, StepDefinitionDraft.revision, StepDefinitionDraft.draftJson, StepDefinitionDraft.draftHash, StepDefinitionDraft.validationReportJson (+more)

### Community 6 - "StepDefinitionDraftArtifact"
...
### Community 7 - "StepReviewedExtension"
Nodes (16): StepReviewedExtension, StepReviewedExtension.id, StepReviewedExtension.version, StepReviewedExtension.exportName, StepReviewedExtension.runtime, StepReviewedExtension.capabilitiesJson, StepReviewedExtension.contractSource, StepReviewedExtension.source (+more)

### Community 8 - "StepHumanProjection"
...
### Community 9 - "StepExecutionBinding"
...
### Community 10 - "StepPublicationReceipt"
...
### Community 11 - "StepDefinitionDeprecation"
...
### Community 12 - "StepCompatibilityReference"
...
### Community 16 - "StepBlockStep"
Nodes (8): StepBlockStep, StepBlockStep.id, StepBlockStep.stepBlockId, StepBlockStep.order, StepBlockStep.invocationJson, StepBlockStep.parameterMap, StepBlockStep.compositionVersionHash, StepBlockStep.stepBlock
...
### Community 19 - "TestCaseFlowBlock"
...
### Community 20 - "TestCaseFlowBlockNode"
...
### Community 22 - "TemplateTestCaseStep"
...
### Community 23 - "TemplateTestCaseFlowBlock"
...
### Community 24 - "TemplateTestCaseFlowBlockNode"
...
### Community 25 - "TemplateTestCaseStepParameter"
...
### Community 26 - "TestCaseStepParameter"
...
### Community 34 - "BaselineAttemptEvent"
...
### Community 35 - "TargetProject"
Nodes (39): TargetProject, TargetProject.id, TargetProject.canonicalPath, TargetProject.displayName, TargetProject.description, TargetProject.packageName, TargetProject.packageManager, TargetProject.packageJson (+more)

### Community 36 - "AgentPreflightReceipt"
...
### Community 37 - "PlanOperationMetric"
...
### Community 38 - "LifecycleCertificationReceipt"
...
### Community 39 - "ValidationResourceProposal"
...
### Community 40 - "ProjectResourceOwnership"
...
### Community 41 - "ProjectResourceImport"
...
### Community 45 - "RepositoryExportJobState"
...
### Community 46 - "RepositoryExportJob"
...
### Community 47 - "RepositoryExportReceipt"
...
### Community 49 - "RuntimeCapsuleExecutionAttempt"
...
### Community 50 - "RuntimeCapsuleExecutionAttemptState"
...
### Community 51 - "RuntimeCapsuleBlob"
...
### Community 52 - "RuntimeCapsuleBlobReference"
...
### Community 53 - "RuntimeCapsuleIntegrityState"
...
### Community 54 - "RuntimeCapsuleLease"
...
### Community 55 - "ProviderAdapterRegistration"
...
### Community 56 - "ProviderWorkflowRun"
...
### Community 58 - "ProviderPermissionDecision"
...
### Community 59 - "ProviderArtifactSnapshot"
...
### Community 60 - "PlanTaskProjection"
...
### Community 64 - "AppraiseProjectIdentity"
...
### Community 65 - "DelegatedAuthorizationNonce"
...
### Community 66 - "DelegatedCoordinatorReceipt"
...
### Community 67 - "DelegatedCoordinatorConsumption"
...
### Community 68 - "DelegatedValidationAstSubmission"
...
### Community 69 - "ValidationAstPublishOperation"
...
### Community 70 - "ValidationExtensionReview"
...
### Community 71 - "PlanCoordinatorLease"
...
### Community 72 - "PlanPersonalLayout"
...
### Community 77 - "ConflictResolution"
...
### Community 83 - "ReportScenarioTag"
...
### Community 91 - "TestRunTestCaseStatus"
...
### Community 101 - "StepParameterValueType"
...
### Community 102 - "TemplateStepIcon"
...
### Community 112 - "Boolean"
Nodes (1): Boolean

### Community 113 - "Float"
Nodes (1): Float

### Community 114 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 115 - "TemplateStep"
Nodes (1): TemplateStep

### Community 116 - "TemplateStepGroup"
Nodes (1): TemplateStepGroup

### Community 117 - "TemplateStepParameter"
Nodes (1): TemplateStepParameter

### Community 118 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 119 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 120 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 121 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 122 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 123 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 124 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 125 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 126 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 127 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 128 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 129 - "new_Tag"
Nodes (1): new_Tag

### Community 130 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 131 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 132 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 133 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 134 - "new_TestRun"
Nodes (1): new_TestRun

### Community 135 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 136 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 137 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 138 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 139 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 140 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 141 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 142 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 143 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 144 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 145 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 146 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 147 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 148 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 149 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 150 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 151 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 152 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 153 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 154 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 155 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 156 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 157 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 158 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 159 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 160 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 161 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 162 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 163 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 164 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 165 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 166 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 167 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 168 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 169 - "20260712020000_add_test_run_preparation_key"
Nodes (1): 20260712020000_add_test_run_preparation_key

### Community 170 - "20260712180000_add_repository_exports"
Nodes (1): 20260712180000_add_repository_exports

### Community 171 - "20260713143000_add_project_resource_ownership"
Nodes (1): 20260713143000_add_project_resource_ownership

### Community 172 - "20260713153000_add_validation_resource_proposals"
Nodes (1): 20260713153000_add_validation_resource_proposals

### Community 173 - "20260713163000_normalize_managed_validation_vocabulary"
Nodes (1): 20260713163000_normalize_managed_validation_vocabulary

### Community 174 - "20260713173000_add_named_plan_hashes"
Nodes (1): 20260713173000_add_named_plan_hashes

### Community 175 - "20260713183000_add_delegated_coordinator_receipts"
Nodes (1): 20260713183000_add_delegated_coordinator_receipts

### Community 176 - "20260713200000_stage_complete_project_ownership"
Nodes (1): 20260713200000_stage_complete_project_ownership

### Community 177 - "20260713210000_add_target_project_description"
Nodes (1): 20260713210000_add_target_project_description

### Community 178 - "20260713211000_scope_test_run_preparation_key"
Nodes (1): 20260713211000_scope_test_run_preparation_key

### Community 179 - "20260714000000_make_template_library_shared"
Nodes (1): 20260714000000_make_template_library_shared

### Community 180 - "20260714143000_add_validation_review_state_receipt"
Nodes (1): 20260714143000_add_validation_review_state_receipt

### Community 181 - "20260714160500_scope_environment_names_to_project"
Nodes (1): 20260714160500_scope_environment_names_to_project

### Community 182 - "20260716190000_replace_environment_password_with_reference"
Nodes (1): 20260716190000_replace_environment_password_with_reference

### Community 183 - "new_Environment"
Nodes (1): new_Environment

### Community 184 - "20260716210000_add_measured_test_run_pagination_index"
Nodes (1): 20260716210000_add_measured_test_run_pagination_index

### Community 185 - "20260718110000_add_agent_preflight_receipts"
Nodes (1): 20260718110000_add_agent_preflight_receipts

### Community 186 - "20260718160000_add_plan_observability"
Nodes (1): 20260718160000_add_plan_observability

### Community 187 - "20260718193000_add_environment_identity_expectation"
Nodes (1): 20260718193000_add_environment_identity_expectation

### Community 188 - "20260720010000_add_canonical_operation_mappings"
Nodes (1): 20260720010000_add_canonical_operation_mappings

### Community 189 - "20260722013000_scope_locator_group_names_to_project"
Nodes (1): 20260722013000_scope_locator_group_names_to_project

### Community 190 - "20260722190000_add_step_definition_registry"
Nodes (1): 20260722190000_add_step_definition_registry

### Community 191 - "20260722223000_add_step_definition_reviewed_extensions"
Nodes (1): 20260722223000_add_step_definition_reviewed_extensions

### Community 192 - "20260725190000_add_step_block_migration_ledger"
Nodes (1): 20260725190000_add_step_block_migration_ledger

### Community 193 - "StepBlockMigrationLedger"
...
### Community 197 - "20260725194500_cut_over_authored_steps_to_step_invocations"
