...
## Corpus Check
- 74 files from prisma/schema.prisma and migrations
- Verdict: schema-aware graph generated because Graphify AST extraction does not currently produce Prisma/SQL nodes.

## Summary
- 1249 nodes · 2742 edges · 245 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `String` - 435 edges
2. `schema.prisma` - 184 edges
3. `TargetProject` - 137 edges
4. `DateTime` - 115 edges
5. `TestRun` - 74 edges
6. `QualityPlanRevision` - 70 edges
7. `Assessment` - 57 edges
8. `QualityValidationPublication` - 53 edges
9. `TestCase` - 52 edges
10. `ValidationVersion` - 47 edges
...
Nodes (26): TestRun, TestRun.id, TestRun.name, TestRun.preparationKey, TestRun.runId, TestRun.startedAt, TestRun.completedAt, TestRun.status (+more)

### Community 31 - "TargetProject"
Nodes (36): TargetProject, TargetProject.id, TargetProject.canonicalPath, TargetProject.displayName, TargetProject.description, TargetProject.packageName, TargetProject.packageManager, TargetProject.packageJson (+more)

### Community 32 - "AgentPreflightReceipt"
...
### Community 33 - "LifecycleCertificationReceipt"
...
### Community 34 - "ProjectResourceOwnership"
...
### Community 35 - "ProjectResourceImport"
...
### Community 39 - "RuntimeCapsuleExecutionAttempt"
...
### Community 40 - "RuntimeCapsuleExecutionAttemptState"
...
### Community 41 - "RuntimeCapsuleBlob"
...
### Community 42 - "RuntimeCapsuleBlobReference"
...
### Community 43 - "RuntimeCapsuleIntegrityState"
...
### Community 44 - "RuntimeCapsuleLease"
...
### Community 46 - "EnvironmentCredentialState"
...
### Community 49 - "ConflictResolution"
...
### Community 55 - "ReportScenarioTag"
...
### Community 62 - "QualityPlanRevision"
Nodes (22): QualityPlanRevision, QualityPlanRevision.id, QualityPlanRevision.targetProjectId, QualityPlanRevision.qualityPlanId, QualityPlanRevision.revision, QualityPlanRevision.status, QualityPlanRevision.approvedAt, QualityPlanRevision.contentHash (+more)

### Community 63 - "RequirementSnapshot"
...
### Community 65 - "QualityObligationRevision"
...
### Community 66 - "ValidationVersion"
Nodes (23): ValidationVersion, ValidationVersion.id, ValidationVersion.targetProjectId, ValidationVersion.qualityPlanRevisionId, ValidationVersion.validationIdentity, ValidationVersion.version, ValidationVersion.status, ValidationVersion.reuseOutcome (+more)

### Community 67 - "QualityValidationPublication"
Nodes (32): QualityValidationPublication, QualityValidationPublication.id, QualityValidationPublication.targetProjectId, QualityValidationPublication.targetFingerprint, QualityValidationPublication.qualityPlanRevisionId, QualityValidationPublication.validationVersionId, QualityValidationPublication.idempotencyKey, QualityValidationPublication.operationHash (+more)

### Community 68 - "QualityValidationExtensionReview"
...
### Community 69 - "ObligationValidationVersion"
...
### Community 70 - "EvaluationSubjectRevision"
Nodes (10): EvaluationSubjectRevision, EvaluationSubjectRevision.id, EvaluationSubjectRevision.subjectDigest, EvaluationSubjectRevision.subjectKind, EvaluationSubjectRevision.authority, EvaluationSubjectRevision.metadataJson, EvaluationSubjectRevision.createdAt, EvaluationSubjectRevision.assessments (+more)

### Community 71 - "Assessment"
Nodes (21): Assessment, Assessment.id, Assessment.targetProjectId, Assessment.qualityPlanId, Assessment.qualityPlanRevisionId, Assessment.evaluationSubjectRevisionId, Assessment.status, Assessment.alignment (+more)

### Community 72 - "AssessmentRun"
Nodes (19): AssessmentRun, AssessmentRun.id, AssessmentRun.targetProjectId, AssessmentRun.assessmentId, AssessmentRun.qualityPlanRevisionId, AssessmentRun.evaluationSubjectRevisionId, AssessmentRun.idempotencyScope, AssessmentRun.idempotencyKey (+more)

### Community 73 - "AssessmentRunBinding"
Nodes (17): AssessmentRunBinding, AssessmentRunBinding.id, AssessmentRunBinding.assessmentRunId, AssessmentRunBinding.validationVersionId, AssessmentRunBinding.resultMatrixCell, AssessmentRunBinding.testRunId, AssessmentRunBinding.runtimeInputHash, AssessmentRunBinding.terminalOutcome (+more)

### Community 74 - "EvidenceReceipt"
Nodes (25): EvidenceReceipt, EvidenceReceipt.id, EvidenceReceipt.targetProjectId, EvidenceReceipt.qualityPlanRevisionId, EvidenceReceipt.assessmentId, EvidenceReceipt.validationVersionId, EvidenceReceipt.evaluationSubjectRevisionId, EvidenceReceipt.resultMatrixCell (+more)

### Community 75 - "AssessmentDecision"
...
### Community 76 - "RequirementDriftReport"
...
### Community 79 - "TestRunTestCaseStatus"
...
### Community 87 - "StepType"
Nodes (3): StepType, StepType.ACTION, StepType.ASSERTION

### Community 88 - "StepParameterType"
...
### Community 89 - "StepParameterValueType"
...
### Community 97 - "QualityPlanRevisionStatus"
...
### Community 98 - "RequirementSnapshotKind"
...
### Community 99 - "RequirementQueryStatus"
...
### Community 102 - "ValidationReuseOutcome"
...
### Community 105 - "AssessmentRunStatus"
...
### Community 106 - "RequirementAlignmentStatus"
...
### Community 108 - "AssessmentDecisionOutcome"
...
### Community 109 - "RequirementDriftStatus"
...
### Community 116 - "TemplateStep"
Nodes (1): TemplateStep

### Community 117 - "TemplateStepGroup"
Nodes (1): TemplateStepGroup

### Community 118 - "TemplateStepParameter"
Nodes (1): TemplateStepParameter

### Community 119 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 120 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 121 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 122 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 123 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 124 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 125 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 126 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 127 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 128 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 129 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 130 - "new_Tag"
Nodes (1): new_Tag

### Community 131 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 132 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 133 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 134 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 135 - "new_TestRun"
Nodes (1): new_TestRun

### Community 136 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 137 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 138 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 139 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 140 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 141 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 142 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 143 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 144 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 145 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 146 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 147 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 148 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 149 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 150 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 151 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 152 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 153 - "PlanProjection"
Nodes (1): PlanProjection

### Community 154 - "PlanRevision"
Nodes (1): PlanRevision

### Community 155 - "PlanSyncIssue"
Nodes (1): PlanSyncIssue

### Community 156 - "PlanTaskProjection"
Nodes (1): PlanTaskProjection

### Community 157 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 158 - "PlanEvent"
Nodes (1): PlanEvent

### Community 159 - "PlanPersonalLayout"
Nodes (1): PlanPersonalLayout

### Community 160 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 161 - "AppraiseProjectIdentity"
Nodes (1): AppraiseProjectIdentity

### Community 162 - "PlanCoordinatorLease"
Nodes (1): PlanCoordinatorLease

### Community 163 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 164 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 165 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 166 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 167 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 168 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 169 - "ProviderAdapterRegistration"
Nodes (1): ProviderAdapterRegistration

### Community 170 - "ProviderArtifactSnapshot"
Nodes (1): ProviderArtifactSnapshot

### Community 171 - "ProviderPermissionDecision"
Nodes (1): ProviderPermissionDecision

### Community 172 - "ProviderRunEvent"
Nodes (1): ProviderRunEvent

### Community 173 - "ProviderWorkflowRun"
Nodes (1): ProviderWorkflowRun

### Community 174 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 175 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 176 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 177 - "StepBlock"
Nodes (1): StepBlock

### Community 178 - "StepBlockStep"
Nodes (1): StepBlockStep

### Community 179 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 180 - "BaselineAttempt"
Nodes (1): BaselineAttempt

### Community 181 - "BaselineAttemptEvent"
Nodes (1): BaselineAttemptEvent

### Community 182 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 183 - "DelegatedAuthorizationNonce"
Nodes (1): DelegatedAuthorizationNonce

### Community 184 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 185 - "DelegatedValidationAstSubmission"
Nodes (1): DelegatedValidationAstSubmission

### Community 186 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 187 - "ValidationAstPublishOperation"
Nodes (1): ValidationAstPublishOperation

### Community 188 - "ValidationExtensionReview"
Nodes (1): ValidationExtensionReview

### Community 189 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 190 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 191 - "20260712020000_add_test_run_preparation_key"
Nodes (1): 20260712020000_add_test_run_preparation_key

### Community 192 - "20260712180000_add_repository_exports"
Nodes (1): 20260712180000_add_repository_exports

### Community 193 - "RepositoryExportJob"
Nodes (1): RepositoryExportJob

### Community 194 - "RepositoryExportReceipt"
Nodes (1): RepositoryExportReceipt

### Community 195 - "20260713143000_add_project_resource_ownership"
Nodes (1): 20260713143000_add_project_resource_ownership

### Community 196 - "20260713153000_add_validation_resource_proposals"
Nodes (1): 20260713153000_add_validation_resource_proposals

### Community 197 - "ValidationResourceProposal"
...
### Community 201 - "DelegatedCoordinatorConsumption"
Nodes (1): DelegatedCoordinatorConsumption

### Community 202 - "DelegatedCoordinatorReceipt"
Nodes (1): DelegatedCoordinatorReceipt

### Community 203 - "20260713200000_stage_complete_project_ownership"
Nodes (1): 20260713200000_stage_complete_project_ownership

### Community 204 - "20260713210000_add_target_project_description"
Nodes (1): 20260713210000_add_target_project_description

### Community 205 - "20260713211000_scope_test_run_preparation_key"
Nodes (1): 20260713211000_scope_test_run_preparation_key

### Community 206 - "20260714000000_make_template_library_shared"
Nodes (1): 20260714000000_make_template_library_shared

### Community 207 - "20260714143000_add_validation_review_state_receipt"
Nodes (1): 20260714143000_add_validation_review_state_receipt

### Community 208 - "20260714160500_scope_environment_names_to_project"
Nodes (1): 20260714160500_scope_environment_names_to_project

### Community 209 - "20260716190000_replace_environment_password_with_reference"
Nodes (1): 20260716190000_replace_environment_password_with_reference

### Community 210 - "new_Environment"
Nodes (1): new_Environment

### Community 211 - "20260716210000_add_measured_test_run_pagination_index"
Nodes (1): 20260716210000_add_measured_test_run_pagination_index

### Community 212 - "20260718110000_add_agent_preflight_receipts"
Nodes (1): 20260718110000_add_agent_preflight_receipts

### Community 213 - "20260718160000_add_plan_observability"
Nodes (1): 20260718160000_add_plan_observability

### Community 214 - "PlanOperationMetric"
Nodes (1): PlanOperationMetric

### Community 215 - "20260718193000_add_environment_identity_expectation"
Nodes (1): 20260718193000_add_environment_identity_expectation

### Community 216 - "20260720010000_add_canonical_operation_mappings"
Nodes (1): 20260720010000_add_canonical_operation_mappings

### Community 217 - "20260722013000_scope_locator_group_names_to_project"
Nodes (1): 20260722013000_scope_locator_group_names_to_project

### Community 218 - "20260722190000_add_step_definition_registry"
Nodes (1): 20260722190000_add_step_definition_registry

### Community 219 - "StepCompatibilityReference"
Nodes (1): StepCompatibilityReference

### Community 220 - "20260722223000_add_step_definition_reviewed_extensions"
Nodes (1): 20260722223000_add_step_definition_reviewed_extensions

### Community 221 - "20260725190000_add_step_block_migration_ledger"
Nodes (1): 20260725190000_add_step_block_migration_ledger

### Community 222 - "StepBlockMigrationLedger"
Nodes (1): StepBlockMigrationLedger

### Community 223 - "_LegacyCompositionDefinition"
Nodes (1): _LegacyCompositionDefinition

### Community 224 - "20260725193000_make_validation_projection_template_step_optional"
Nodes (1): 20260725193000_make_validation_projection_template_step_optional

### Community 225 - "new_TestCaseStep"
Nodes (1): new_TestCaseStep

### Community 226 - "20260725194500_cut_over_authored_steps_to_step_invocations"
Nodes (1): 20260725194500_cut_over_authored_steps_to_step_invocations

### Community 227 - "IF"
Nodes (1): IF

### Community 228 - "20260725200000_remove_legacy_step_authority"
Nodes (1): 20260725200000_remove_legacy_step_authority

### Community 229 - "20260725201000_add_step_definition_telemetry"
Nodes (1): 20260725201000_add_step_definition_telemetry

### Community 230 - "20260725202000_add_step_definition_reuse_justification"
Nodes (1): 20260725202000_add_step_definition_reuse_justification

### Community 231 - "20260725203000_add_step_definition_review_receipts"
Nodes (1): 20260725203000_add_step_definition_review_receipts

### Community 232 - "20260725204000_harden_step_definition_evidence_and_telemetry"
Nodes (1): 20260725204000_harden_step_definition_evidence_and_telemetry

### Community 233 - "20260725205000_add_reviewed_extension_revocation"
Nodes (1): 20260725205000_add_reviewed_extension_revocation

### Community 234 - "20260725206000_add_step_definition_search_receipts"
Nodes (1): 20260725206000_add_step_definition_search_receipts

### Community 235 - "20260803000000_add_quality_design_assessment"
Nodes (1): 20260803000000_add_quality_design_assessment

### Community 236 - "20260805200000_allow_multiple_validation_node_decisions"
Nodes (1): 20260805200000_allow_multiple_validation_node_decisions

### Community 237 - "20260807110000_add_workflow_reliability_receipts"
Nodes (1): 20260807110000_add_workflow_reliability_receipts

### Community 238 - "CoordinatorFailureReceipt"
Nodes (1): CoordinatorFailureReceipt

### Community 239 - "CoordinatorOperationReceipt"
Nodes (1): CoordinatorOperationReceipt

### Community 240 - "ValidationDecisionReceipt"
Nodes (1): ValidationDecisionReceipt

### Community 241 - "ValidationNodePublication"
Nodes (1): ValidationNodePublication

### Community 242 - "__WorkflowReliabilityMigrationGuard"
Nodes (1): __WorkflowReliabilityMigrationGuard

### Community 243 - "20260810000000_add_assessment_execution_cutover"
Nodes (1): 20260810000000_add_assessment_execution_cutover

### Community 244 - "new_RuntimeCapsule"
