...
## Summary
- 2049 nodes · 4692 edges · 295 communities
...
10. `CollaborationBinding` - 74 edges
...
### Community 92 - "CollaborationBinding"
Nodes (28): CollaborationBinding, CollaborationBinding.id, CollaborationBinding.targetProjectId, CollaborationBinding.portableProjectId, CollaborationBinding.repositoryRoot, CollaborationBinding.remoteName, CollaborationBinding.trackedBranch, CollaborationBinding.enabled (+more)

### Community 93 - "CollaborationEntityMap"
...
### Community 94 - "CollaborationBaseline"
...
### Community 95 - "CollaborationEnvironmentMapping"
...
### Community 96 - "CollaborationOperation"
Nodes (39): CollaborationOperation, CollaborationOperation.id, CollaborationOperation.bindingId, CollaborationOperation.intent, CollaborationOperation.trigger, CollaborationOperation.state, CollaborationOperation.version, CollaborationOperation.idempotencyKey (+more)

### Community 97 - "CollaborationAttempt"
...
### Community 98 - "CollaborationPolicyGrant"
...
### Community 99 - "CollaborationDecision"
...
### Community 100 - "CollaborationJournalEntry"
...
### Community 101 - "CollaborationWorker"
...
### Community 102 - "CollaborationHandoffTicket"
...
### Community 103 - "CollaborationReuseAsset"
...
### Community 104 - "CollaborationNotification"
...
### Community 105 - "CollaborationMutationLock"
...
### Community 108 - "ConflictResolution"
...
### Community 112 - "ReportFeatureTag"
...
### Community 114 - "ReportScenarioTag"
...
### Community 118 - "TestSuiteMetrics"
...
### Community 119 - "DashboardMetrics"
...
### Community 124 - "TestRunTestCaseStatus"
...
### Community 127 - "TestRunEvidenceHealth"
...
### Community 132 - "StepType"
Nodes (3): StepType, StepType.ACTION, StepType.ASSERTION

### Community 133 - "StepParameterType"
...
### Community 134 - "StepParameterValueType"
...
### Community 142 - "QualityJourneyStage"
...
### Community 143 - "QualityJourneyRole"
...
### Community 144 - "QualityJourneyWorkItemStatus"
...
### Community 145 - "QualityJourneyTriageAssignment"
...
### Community 146 - "QualityJourneyTriageReport"
...
### Community 147 - "QualityJourneyReportReview"
...
### Community 148 - "QualityJourneyClosure"
...
### Community 154 - "20251026202316_migrate_back_to_sqlite"
Nodes (1): 20251026202316_migrate_back_to_sqlite

### Community 155 - "TemplateStep"
Nodes (1): TemplateStep

### Community 156 - "TemplateStepGroup"
Nodes (1): TemplateStepGroup

### Community 157 - "TemplateStepParameter"
Nodes (1): TemplateStepParameter

### Community 158 - "_TagToTestRun"
Nodes (1): _TagToTestRun

### Community 159 - "_TestSuiteTestCases"
Nodes (1): _TestSuiteTestCases

### Community 160 - "20251104113456_add_type_for_template_step_groups"
Nodes (1): 20251104113456_add_type_for_template_step_groups

### Community 161 - "new_TemplateStepGroup"
Nodes (1): new_TemplateStepGroup

### Community 162 - "20251104170946_add_tags_to_test_suite_and_test_case"
Nodes (1): 20251104170946_add_tags_to_test_suite_and_test_case

### Community 163 - "_TagToTestCase"
Nodes (1): _TagToTestCase

### Community 164 - "_TagToTestSuite"
Nodes (1): _TagToTestSuite

### Community 165 - "20251112190024_add_cascade_delete_to_test_run_test_case"
Nodes (1): 20251112190024_add_cascade_delete_to_test_run_test_case

### Community 166 - "new_TestRunTestCase"
Nodes (1): new_TestRunTestCase

### Community 167 - "20251113181100_add_test_run_log"
Nodes (1): 20251113181100_add_test_run_log

### Community 168 - "20251119191838_add_tag_type"
Nodes (1): 20251119191838_add_tag_type

### Community 169 - "new_Tag"
Nodes (1): new_Tag

### Community 170 - "20251121164059_add_conflict_resolution"
Nodes (1): 20251121164059_add_conflict_resolution

### Community 171 - "20251130190737_add_trace_path_to_test_run_test_case"
Nodes (1): 20251130190737_add_trace_path_to_test_run_test_case

### Community 172 - "20251213074835_add_log_path_to_test_run"
Nodes (1): 20251213074835_add_log_path_to_test_run

### Community 173 - "20251213183952_add_name_property_for_the_test_run_entities"
Nodes (1): 20251213183952_add_name_property_for_the_test_run_entities

### Community 174 - "new_TestRun"
Nodes (1): new_TestRun

### Community 175 - "20251223183400_add_report_model_to_db_schema"
Nodes (1): 20251223183400_add_report_model_to_db_schema

### Community 176 - "20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases"
Nodes (1): 20251223183637_add_report_test_case_entity_for_storing_test_results_for_individual_test_cases

### Community 177 - "20251224083549_add_comprehensive_report_storage"
Nodes (1): 20251224083549_add_comprehensive_report_storage

### Community 178 - "new_ReportTestCase"
Nodes (1): new_ReportTestCase

### Community 179 - "20251229194422_migrate_duration_to_string"
Nodes (1): 20251229194422_migrate_duration_to_string

### Community 180 - "new_ReportHook"
Nodes (1): new_ReportHook

### Community 181 - "new_ReportStep"
Nodes (1): new_ReportStep

### Community 182 - "20251230124637_add_unique_constraint_to_test_run_name"
Nodes (1): 20251230124637_add_unique_constraint_to_test_run_name

### Community 183 - "20260115094436_add_dashboard_metrics"
Nodes (1): 20260115094436_add_dashboard_metrics

### Community 184 - "20260127172022_add_cascade_delete_to_step_parameters"
Nodes (1): 20260127172022_add_cascade_delete_to_step_parameters

### Community 185 - "new_TemplateTestCaseStepParameter"
Nodes (1): new_TemplateTestCaseStepParameter

### Community 186 - "new_TestCaseStepParameter"
Nodes (1): new_TestCaseStepParameter

### Community 187 - "20260313093000_add_report_step_screenshot_path"
Nodes (1): 20260313093000_add_report_step_screenshot_path

### Community 188 - "20260318120000_add_test_suite_context_to_test_run_test_case"
Nodes (1): 20260318120000_add_test_suite_context_to_test_run_test_case

### Community 189 - "20260318173512_add_support_of_test_suite_level_runs"
Nodes (1): 20260318173512_add_support_of_test_suite_level_runs

### Community 190 - "20260507000000_add_flow_builder_node_grouping"
Nodes (1): 20260507000000_add_flow_builder_node_grouping

### Community 191 - "20260609002500_add_plan_projection_and_sync"
Nodes (1): 20260609002500_add_plan_projection_and_sync

### Community 192 - "PlanProjection"
Nodes (1): PlanProjection

### Community 193 - "PlanRevision"
Nodes (1): PlanRevision

### Community 194 - "PlanSyncIssue"
Nodes (1): PlanSyncIssue

### Community 195 - "PlanTaskProjection"
Nodes (1): PlanTaskProjection

### Community 196 - "20260609090000_add_plan_review_runtime"
Nodes (1): 20260609090000_add_plan_review_runtime

### Community 197 - "PlanEvent"
Nodes (1): PlanEvent

### Community 198 - "PlanPersonalLayout"
Nodes (1): PlanPersonalLayout

### Community 199 - "20260609160000_add_coordinator_events_api_mcp"
Nodes (1): 20260609160000_add_coordinator_events_api_mcp

### Community 200 - "AppraiseProjectIdentity"
Nodes (1): AppraiseProjectIdentity

### Community 201 - "PlanCoordinatorLease"
Nodes (1): PlanCoordinatorLease

### Community 202 - "new_PlanEvent"
Nodes (1): new_PlanEvent

### Community 203 - "20260613015000_add_plan_description"
Nodes (1): 20260613015000_add_plan_description

### Community 204 - "20260628090000_add_target_projects"
Nodes (1): 20260628090000_add_target_projects

### Community 205 - "new_PlanProjection"
Nodes (1): new_PlanProjection

### Community 206 - "20260628103000_add_plan_slug_legacy_identity"
Nodes (1): 20260628103000_add_plan_slug_legacy_identity

### Community 207 - "20260701090000_add_provider_workflow_runs"
Nodes (1): 20260701090000_add_provider_workflow_runs

### Community 208 - "ProviderAdapterRegistration"
Nodes (1): ProviderAdapterRegistration

### Community 209 - "ProviderArtifactSnapshot"
Nodes (1): ProviderArtifactSnapshot

### Community 210 - "ProviderPermissionDecision"
Nodes (1): ProviderPermissionDecision

### Community 211 - "ProviderRunEvent"
Nodes (1): ProviderRunEvent

### Community 212 - "ProviderWorkflowRun"
Nodes (1): ProviderWorkflowRun

### Community 213 - "20260701120000_add_provider_registration_settings"
Nodes (1): 20260701120000_add_provider_registration_settings

### Community 214 - "20260708090000_add_test_run_evidence_health"
Nodes (1): 20260708090000_add_test_run_evidence_health

### Community 215 - "20260709090000_add_step_blocks"
Nodes (1): 20260709090000_add_step_blocks

### Community 216 - "StepBlock"
Nodes (1): StepBlock

### Community 217 - "StepBlockStep"
Nodes (1): StepBlockStep

### Community 218 - "20260711120000_add_baseline_attempt_history"
Nodes (1): 20260711120000_add_baseline_attempt_history

### Community 219 - "BaselineAttempt"
Nodes (1): BaselineAttempt

### Community 220 - "BaselineAttemptEvent"
Nodes (1): BaselineAttemptEvent

### Community 221 - "20260711150000_add_delegated_authorization_nonces"
Nodes (1): 20260711150000_add_delegated_authorization_nonces

### Community 222 - "DelegatedAuthorizationNonce"
Nodes (1): DelegatedAuthorizationNonce

### Community 223 - "20260711170000_add_delegated_ast_submissions"
Nodes (1): 20260711170000_add_delegated_ast_submissions

### Community 224 - "DelegatedValidationAstSubmission"
Nodes (1): DelegatedValidationAstSubmission

### Community 225 - "20260711190000_add_validation_ast_publish_journal"
Nodes (1): 20260711190000_add_validation_ast_publish_journal

### Community 226 - "ValidationAstPublishOperation"
Nodes (1): ValidationAstPublishOperation

### Community 227 - "ValidationExtensionReview"
Nodes (1): ValidationExtensionReview

### Community 228 - "20260711220000_add_runtime_capsules"
Nodes (1): 20260711220000_add_runtime_capsules

### Community 229 - "20260712010000_add_runtime_capsule_execution_attempt"
Nodes (1): 20260712010000_add_runtime_capsule_execution_attempt

### Community 230 - "20260712020000_add_test_run_preparation_key"
Nodes (1): 20260712020000_add_test_run_preparation_key

### Community 231 - "20260712180000_add_repository_exports"
Nodes (1): 20260712180000_add_repository_exports

### Community 232 - "RepositoryExportJob"
Nodes (1): RepositoryExportJob

### Community 233 - "RepositoryExportReceipt"
Nodes (1): RepositoryExportReceipt

### Community 234 - "20260713143000_add_project_resource_ownership"
Nodes (1): 20260713143000_add_project_resource_ownership

### Community 235 - "20260713153000_add_validation_resource_proposals"
Nodes (1): 20260713153000_add_validation_resource_proposals

### Community 236 - "ValidationResourceProposal"
Nodes (1): ValidationResourceProposal

### Community 237 - "20260713163000_normalize_managed_validation_vocabulary"
Nodes (1): 20260713163000_normalize_managed_validation_vocabulary

### Community 238 - "20260713173000_add_named_plan_hashes"
Nodes (1): 20260713173000_add_named_plan_hashes

### Community 239 - "20260713183000_add_delegated_coordinator_receipts"
Nodes (1): 20260713183000_add_delegated_coordinator_receipts

### Community 240 - "DelegatedCoordinatorConsumption"
Nodes (1): DelegatedCoordinatorConsumption

### Community 241 - "DelegatedCoordinatorReceipt"
Nodes (1): DelegatedCoordinatorReceipt

### Community 242 - "20260713200000_stage_complete_project_ownership"
Nodes (1): 20260713200000_stage_complete_project_ownership

### Community 243 - "20260713210000_add_target_project_description"
Nodes (1): 20260713210000_add_target_project_description

### Community 244 - "20260713211000_scope_test_run_preparation_key"
Nodes (1): 20260713211000_scope_test_run_preparation_key

### Community 245 - "20260714000000_make_template_library_shared"
Nodes (1): 20260714000000_make_template_library_shared

### Community 246 - "20260714143000_add_validation_review_state_receipt"
Nodes (1): 20260714143000_add_validation_review_state_receipt

### Community 247 - "20260714160500_scope_environment_names_to_project"
Nodes (1): 20260714160500_scope_environment_names_to_project

### Community 248 - "20260716190000_replace_environment_password_with_reference"
Nodes (1): 20260716190000_replace_environment_password_with_reference

### Community 249 - "new_Environment"
Nodes (1): new_Environment

### Community 250 - "20260716210000_add_measured_test_run_pagination_index"
Nodes (1): 20260716210000_add_measured_test_run_pagination_index

### Community 251 - "20260718110000_add_agent_preflight_receipts"
Nodes (1): 20260718110000_add_agent_preflight_receipts

### Community 252 - "20260718160000_add_plan_observability"
Nodes (1): 20260718160000_add_plan_observability

### Community 253 - "LifecycleCertificationReceipt"
Nodes (1): LifecycleCertificationReceipt

### Community 254 - "PlanOperationMetric"
Nodes (1): PlanOperationMetric

### Community 255 - "20260718193000_add_environment_identity_expectation"
Nodes (1): 20260718193000_add_environment_identity_expectation

### Community 256 - "20260720010000_add_canonical_operation_mappings"
Nodes (1): 20260720010000_add_canonical_operation_mappings

### Community 257 - "20260722013000_scope_locator_group_names_to_project"
Nodes (1): 20260722013000_scope_locator_group_names_to_project

### Community 258 - "20260722190000_add_step_definition_registry"
Nodes (1): 20260722190000_add_step_definition_registry

### Community 259 - "StepCompatibilityReference"
Nodes (1): StepCompatibilityReference

### Community 260 - "20260722223000_add_step_definition_reviewed_extensions"
Nodes (1): 20260722223000_add_step_definition_reviewed_extensions

### Community 261 - "20260725190000_add_step_block_migration_ledger"
Nodes (1): 20260725190000_add_step_block_migration_ledger

### Community 262 - "StepBlockMigrationLedger"
Nodes (1): StepBlockMigrationLedger

### Community 263 - "_LegacyCompositionDefinition"
Nodes (1): _LegacyCompositionDefinition

### Community 264 - "20260725193000_make_validation_projection_template_step_optional"
Nodes (1): 20260725193000_make_validation_projection_template_step_optional

### Community 265 - "new_TestCaseStep"
Nodes (1): new_TestCaseStep

### Community 266 - "20260725194500_cut_over_authored_steps_to_step_invocations"
Nodes (1): 20260725194500_cut_over_authored_steps_to_step_invocations

### Community 267 - "IF"
Nodes (1): IF

### Community 268 - "20260725200000_remove_legacy_step_authority"
Nodes (1): 20260725200000_remove_legacy_step_authority

### Community 269 - "20260725201000_add_step_definition_telemetry"
Nodes (1): 20260725201000_add_step_definition_telemetry

### Community 270 - "20260725202000_add_step_definition_reuse_justification"
Nodes (1): 20260725202000_add_step_definition_reuse_justification

### Community 271 - "20260725203000_add_step_definition_review_receipts"
Nodes (1): 20260725203000_add_step_definition_review_receipts

### Community 272 - "20260725204000_harden_step_definition_evidence_and_telemetry"
Nodes (1): 20260725204000_harden_step_definition_evidence_and_telemetry

### Community 273 - "20260725205000_add_reviewed_extension_revocation"
Nodes (1): 20260725205000_add_reviewed_extension_revocation

### Community 274 - "20260725206000_add_step_definition_search_receipts"
Nodes (1): 20260725206000_add_step_definition_search_receipts

### Community 275 - "20260906090000_quality_journey_authority"
Nodes (1): 20260906090000_quality_journey_authority

### Community 276 - "new_DashboardMetrics"
Nodes (1): new_DashboardMetrics

### Community 277 - "new_Locator"
Nodes (1): new_Locator

### Community 278 - "new_LocatorGroup"
Nodes (1): new_LocatorGroup

### Community 279 - "new_Module"
Nodes (1): new_Module

### Community 280 - "new_ProjectResourceOwnership"
Nodes (1): new_ProjectResourceOwnership

### Community 281 - "new_Report"
Nodes (1): new_Report

### Community 282 - "new_StepDefinitionSearchReceipt"
Nodes (1): new_StepDefinitionSearchReceipt

### Community 283 - "new_StepDefinitionTelemetryEvent"
Nodes (1): new_StepDefinitionTelemetryEvent

### Community 284 - "new_TargetProject"
Nodes (1): new_TargetProject

### Community 285 - "new_TemplateTestCase"
Nodes (1): new_TemplateTestCase

### Community 286 - "new_TestCase"
Nodes (1): new_TestCase

### Community 287 - "new_TestCaseMetrics"
Nodes (1): new_TestCaseMetrics

### Community 288 - "new_TestSuite"
Nodes (1): new_TestSuite

### Community 289 - "new_TestSuiteMetrics"
Nodes (1): new_TestSuiteMetrics

### Community 290 - "20260906180000_add_quality_journey_coordinator_handoffs"
Nodes (1): 20260906180000_add_quality_journey_coordinator_handoffs

### Community 291 - "20260907090000_add_quality_journey_drafts"
Nodes (1): 20260907090000_add_quality_journey_drafts

### Community 292 - "20260908170000_add_repository_collaboration"
Nodes (1): 20260908170000_add_repository_collaboration

### Community 293 - "20260908190000_add_journey_reuse_annotation"
Nodes (1): 20260908190000_add_journey_reuse_annotation

### Community 294 - "20260909090000_add_repository_collaboration_queue_worker"
