...
When(
  ...
  async function (this: CustomWorld, variableName: string) {
    ...
    try {
      ...
      throw new Error(
        `Failed to generate a random email and store it inside the variable ${variableName}: ${error}`
      );
    }
  }
);
...
When(
  ...
  async function (this: CustomWorld, variableName: string) {
    ...
    try {
      ...
      throw new Error(
        `Failed to generate a random phone and store it inside the variable ${variableName}: ${error}`
      );
    }
  }
);
