...
export async function validateAppraiseProject(projectRoot) {
    ...
    if (!scripts['appraisejs:install-step']) {
        throw new Error(`The target project is missing the "appraisejs:install-step" script. Upgrade the project scaffold before using this CLI.`);
    }
