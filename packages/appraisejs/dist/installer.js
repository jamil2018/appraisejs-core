...
export async function writePayloadToTempFile(payload) {
...
export async function removeTempPayloadFile(filePath) {
    await fs.rm(path.dirname(filePath), { recursive: true, force: true });
}
function getRunArgs(packageManager, payloadFile, overwrite, dryRun) {
...
export async function runLocalInstaller(packageManager, cwd, payloadFile, overwrite, dryRun) {
