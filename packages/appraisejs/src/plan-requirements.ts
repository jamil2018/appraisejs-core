...
const requirementDefinitions: RequirementDefinition[] = [
  ...
  },
  {
    ...
    text: 'Create records',
    kind: 'functional',
    pattern: /\b(?:crud|creat(?:e|es|ed|ing)|add(?:s|ed|ing)?)\b/i,
    coveragePatterns: [/\b(?:creat(?:e|es|ed|ing)|add(?:s|ed|ing)?)\b/i],
  },
  {
    id: 'edit',
    text: 'Edit records',
    kind: 'functional',
    pattern: /\b(?:crud|edit(?:s|ed|ing)?|updat(?:e|es|ed|ing))\b/i,
    coveragePatterns: [/\b(?:edit(?:s|ed|ing)?|updat(?:e|es|ed|ing))\b/i],
  },
  {
    id: 'delete',
    text: 'Delete records',
    kind: 'functional',
    pattern: /\b(?:crud|delet(?:e|es|ed|ing)|remov(?:e|es|ed|ing))\b/i,
    coveragePatterns: [/\b(?:delet(?:e|es|ed|ing)|remov(?:e|es|ed|ing))\b/i],
  },
  {
    id: 'completion',
  ...
  {
    id: 'clear-completed',
    text: 'Clear all completed records',
    kind: 'functional',
    pattern: /\bclear(?:s|ed|ing)?\s+(?:all\s+)?completed\b/i,
    coveragePatterns: [/\bclear(?:s|ed|ing)?\b/i, /\bcompleted\b/i],
  },
  {
    id: 'filter-persistence',
    text: 'Persist the selected filter',
    kind: 'functional',
    pattern: /\b(?:persist(?:s|ed|ing)?|remember(?:s|ed|ing)?)\b[^.\n]{0,80}\b(?:selected|active|current)?\s*filter\b/i,
    coveragePatterns: [/\b(?:persist|remember|restore|reload)/i, /\bfilter/i],
  },
  {
    id: 'empty-states',
    text: 'Useful global and filtered empty states',
    kind: 'quality',
    pattern: /\bempty\s+states?\b/i,
    coveragePatterns: [/\bempty\s+states?\b/i],
  },
  {
    id: 'persistence',
    text: 'Persistent storage',
    kind: 'functional',
    pattern: /\b(?:persist(?:s|ed|ing|ence|ent)?|storage|localstorage|database|sav(?:e|es|ed|ing))\b/i,
  ...
  },
  {
    ...
    kind: 'validation',
    pattern: /\b(?:tests?|validations?|e2e|playwright)\b/i,
