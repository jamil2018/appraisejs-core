...
## Summary
- 1096 nodes · 2076 edges · 61 communities (59 shown, 2 thin omitted)
...
Cohesion: 0.11
Nodes (16): agentOperationProjectionSchema, boundedOperationValueSchema, humanOperationProjectionSchema, identifierSchema, OPERATION_CONTRACT_VERSION, operationAliasSchema, operationDescriptorSchema, operationHashSchema (+8 more)
...
Cohesion: 0.10
Nodes (20): connectInput, executeInput, getInput, handoffRedeemInput, id, policyVersion, prepareInput, records (+12 more)
...
Cohesion: 0.13
Nodes (15): program, expectedAgentCapabilities, addCollaborationJsonCommand(), addOnlineOptions(), agent, collaboration, locatorGraph, OnlineOptions (+7 more)
...
Cohesion: 0.14
Nodes (19): nullableOptionalPositiveInteger(), nullableOptionalString(), operationSearchInputSchema, registerProjectOperations(), identifier, registerQualityJourneyLibraryOperations(), scope, registerRuntimeOperations() (+11 more)
...
Cohesion: 0.24
Nodes (7): operationContentHash(), OperationDefinition, operationDefinitionSchema, OperationDescriptor, operationInvocationSchema, createOperationRegistry(), OperationFilter
...
Cohesion: 0.05
Nodes (39): analysisCharter, analysisCommand, artifactReference, automationLocator, automationMaterializationInput, automationParameter, automationStep, automationTestData (+31 more)
...
## Knowledge Gaps
- **401 isolated node(s):** `name`, `version`, `description`, `license`, `author` (+396 more)
