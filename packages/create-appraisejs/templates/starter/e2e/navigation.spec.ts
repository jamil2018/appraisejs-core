...
test.describe('Navigation @navigation', () => {
  ...
  const listRoutes: RouteExpectation[] = [
    ...
    { path: '/template-step-groups', heading: 'Template Step Groups' },
    { path: '/template-steps', heading: 'Template Steps' },
  ...
  const createRoutes: RouteExpectation[] = [
    ...
    { path: '/template-step-groups/create', heading: 'Create Template Step Group' },
    { path: '/template-steps/create', heading: 'Create Template Step' },
  ...
  test('modify and detail routes render for seeded records', async ({ page }) => {
    const detailRoutes: RouteExpectation[] = [
      ...
      { path: buildModifyPath('/template-step-groups', seededIds.templateStepGroup), heading: 'Name' },
      { path: buildModifyPath('/template-steps', seededIds.templateStep), heading: 'Name' },
      {
