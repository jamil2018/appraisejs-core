      ...
      steps: [
        {
          ...
          invocation: {
            step: { id: 'browser.navigation.goto', version: '1', definitionHash: hashA },
            inputs: { url: '/plans/accessible-plan?review=validation' },
          },
        ...
        },
        {
          ...
          invocation: {
            step: { id: 'browser.mouse.click', version: '1', definitionHash: hashB },
            inputs: { target: { id: 'approve-button' } },
          },
  ...
  it('shows final sign-off only for ready validation-passed evidence and requires explicit confirmation', async () => {
    ...
    const completionDetail: PlanReviewDetail = {
      ...
      completionReview: {
        ...
        blockingRemarks: [],
        nonBlockingRemarks: [],
        efficiencyTelemetry: { capturedAtEventSequence: 9, retained: 0, phases: [] },
