...
export type LocatorTemplateOperation = keyof typeof locatorOptionKeys
export type PageTemplateOperation = keyof typeof pageOptionKeys
...
export async function runLocatorTemplateOperation(
  locator: Locator,
  ...
  const operation = operationName as LocatorTemplateOperation
...
export async function runPageTemplateOperation(
  page: Page,
  operationName: string,
  argumentsJson: string,
  optionsJson: string,
  ...
  const operation = operationName as PageTemplateOperation
  const args = parseArguments(argumentsJson, readStoredVariable)
  const options = parseOptions(optionsJson, readStoredVariable)
