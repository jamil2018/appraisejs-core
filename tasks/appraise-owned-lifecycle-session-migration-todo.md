...
- [x] Integrate the Quality OS domain foundation: methodology, analysis/design revisions, execution consent,
      findings/attribution, review UI, MCP contracts, and certification.
- [x] Preserve the newer remote-scope, partition, preflight, generation/publication, credential, and execution
      authorities while integrating Quality OS.
- [ ] Extend existing Quality OS fixtures into the complete session lifecycle corpus; existing coverage is partial.
...
- [ ] 2.3 Add Appraise-owned role work items, leases, capability envelopes, and hash-bound submissions.
...
- [ ] 4.3 Route bounded target-exploration and validation-implementation roles through session work items.
...
- [ ] 5.4 Separate evidence-analysis proposals from independent binding review.
