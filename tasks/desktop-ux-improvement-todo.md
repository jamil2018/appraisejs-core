...
| Phase 4.1-4.3 | pending | Vocabulary/navigation tests; live command search, Help, Settings, active-project links, keyboard, and console walkthrough; canonical template sync. | Intended-user first-click validation has not occurred, so navigation groups remain unchanged and Task 4.1/checkpoint remain open. See `desktop-ux-phase-4-evidence.md`. |
