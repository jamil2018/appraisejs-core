# Graph Report - src  (2026-09-06)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 4529 nodes · 10688 edges · 203 communities (186 shown, 17 thin omitted)
...
1. `cn()` - 164 edges
2. `requireActiveProjectForMutation()` - 77 edges
3. `ServiceError` - 74 edges
4. `unknownErrorToActionResponse()` - 72 edges
5. `Button()` - 60 edges
6. `StepDefinitionRegistryService` - 45 edges
7. `serviceErrorToActionResponse()` - 43 edges
8. `ActionResponse` - 39 edges
9. `Card()` - 37 edges
10. `Badge()` - 35 edges
...
Cohesion: 0.04
Nodes (50): metadata, AppDrawerItemConfig, { pushMock }, DataCardGrid(), colorMap, ExecutionHealthPanel(), ExecutionHealthPanelProps, quickActions (+42 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (44): DEFAULT_EDGE_STYLE, FlowEdgeMutationGuard, flowEdgeMutationGuardRef, FlowDiagramBlockDialog(), FlowDiagramBlockDialogProps, FlowDiagramGroupingHintsProps, InvocationParseResult, parseInputValue() (+36 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (41): { push, refresh, toast, startLocatorPickerSessionAction, savePickedLocatorAction }, LocatorGroup, locatorGroupFormOpts, locatorGroupSchema, COLLECTION_ROUTES, ProjectOption, ProjectSelector(), CompositionSearchResponse (+33 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (36): getFilterTags(), formatDateTime(), locatorGroupTableCols, locatorTableCols, moduleTableCols, buildModulePath(), ReportTestCaseWithRelations, ViewLogsButton() (+28 more)
...
Cohesion: 0.06
Nodes (46): appendFlowNode(), assertValidAuthoredFlow(), AuthoredFlow, AuthoredFlowNode, createAuthoredFlowNode(), createTemplateAuthoredFlowNode(), flowFromNodeOrder(), initialInvocation() (+38 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (56): advanceAfterWorkCompletion(), AppliedJourneyCommand, assertFactoryAuthorityCurrent(), assertLeaseAuthority(), assertWorkCompletionRole(), assignmentFromAuthorization(), carriedScenarioReviewInput(), commandConflict() (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (44): getFieldErrorMessage(), TestRun, testRunFormOpts, testRunSchema, getActionErrorMessage(), getTestRunSuccessPath(), isModuleRow(), isTestSuitePickerRow() (+36 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (46): AgentPreflightLayerStatus, preflightLayerLabels, PreflightLayerStatus, Project, projectDateFormatter, projectIdentityLabel(), ProjectRow(), testCaseDataColumns (+38 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (39): metadata, InfoCards, ButtonSkeleton(), IconButtonSkeleton(), TestSuite, testSuiteFormOpts, testSuiteSchema, TextInputSkeleton() (+31 more)
...
Cohesion: 0.09
Nodes (55): metadata, Dashboard(), getDashboardMetricsAction(), getEntityMetricsAction(), getTestSuiteExecutionDataAction(), createEnvironmentAction(), deleteEnvironmentAction(), getEnvironmentByIdAction() (+47 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (37): metadata, metadata, CreateFromTemplateForm(), CreateFromTemplateFormProps, collectTemplateStepReferences(), loadCreateFromTemplateRouteResources(), resolveTemplateTestCaseSelection(), getTemplateTestCasesWithSteps() (+29 more)

### Community 14 - "Community 14"
Cohesion: 0.10
Nodes (36): metadata, ModifyLocator(), metadata, metadata, CreateModule(), Module, moduleFormOpts, moduleSchema (+28 more)
...
Cohesion: 0.06
Nodes (33): StepInvocationEditor(), definition, StepInvocationResourceInputs, useStepInvocationResources(), testCaseSchema, flowBlockSchema, testCaseStepSchema, testCaseStepsSchema (+25 more)
...
Cohesion: 0.07
Nodes (39): automationTargetBindingSchema, assertSingleLineGherkin(), generateCucumberConfig(), generateReviewedFeature(), generateSupportFiles(), ExecutionCycle, FrozenSource, JourneyCapsuleSource (+31 more)
...
Cohesion: 0.07
Nodes (41): metadata, metadata, metadata, metadata, ModifyLocator(), metadata, metadata, metadata (+33 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (39): charter(), completedDiscovery(), digest(), fixture(), hash(), phaseSixId(), readyAnalyzer(), registerStartedAnalyzerAdapter() (+31 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (34): contiguousNodeIds(), groupedNodeIds(), nodeIndexById(), normalizeAuthoredFlowBlocks(), definition, flow, updatedFlowBlockMembership(), FlowDiagram() (+26 more)
...
Cohesion: 0.12
Nodes (27): metadata, CreateTestRun(), tagSchema, checkUniqueTagExpression(), checkUniqueTagName(), createTag(), deleteTags(), getTagByIdOrThrow() (+19 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (25): EnvironmentFormProps, { push, toast }, environmentFieldValidators, EnvironmentFormSubmitAction, EnvironmentTableRow, getActionErrorMessage(), FormSubmitButton(), TextFormField() (+17 more)
...
Cohesion: 0.08
Nodes (34): DiscoveryBootstrap, getQualityJourneyDiscoveryBootstrap(), registerQualityJourneyDiscoveryBootstrap(), approvedAnalysisOrThrow(), approvedRequirementSetHash(), assertBundleBase(), assertCrossTargetResourcesMatchFrozenOwnership(), assertResolvedResourcesAreFrozen() (+26 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (39): compileStepDefinitionDraftArtifactAction(), createStepDefinitionDraftAction(), reviseStepDefinitionDraftAction(), saveStepDefinitionDraftArtifactAction(), actionError(), artifactFingerprint(), ArtifactFingerprintSetter, BooleanSetter (+31 more)
...
Cohesion: 0.09
Nodes (27): FlowBlockBounds, FlowDiagramBlockOverlays(), FlowDiagramBlockOverlaysProps, FlowAuthoringSidebarProps, FlowBlockControlsProps, FlowBlocksPanelProps, FlowGraphCanvasProps, FlowNodeSearchProps (+19 more)
...
Cohesion: 0.07
Nodes (34): digest, qualityJourneyClosureInputSchema, artifactReferenceSchema, assignmentAuthorityViolations(), assignmentBoundaryViolations(), assignmentIdentityViolations(), ClosureContractInput, closureContractIssues() (+26 more)
...
Cohesion: 0.10
Nodes (26): closeQualityJourney(), closeQualityJourneyAction(), input, mocks, getAllTestCaseMetricsForFilter(), getAllTestSuiteMetricsForFilter(), getReportByIdOrThrow(), listReports() (+18 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (26): ClosureItem, qualityJourneyClosureItems(), qualityJourneyRemediationScope(), compileQualityJourneyTriageInput(), conflict(), TriageInput, digest(), input() (+18 more)
...
Cohesion: 0.12
Nodes (32): environmentSummary(), assertGenericQualityJourneyWorkCompletion(), bodyRecord(), CoordinatorErrorContext, dispatchGet(), dispatchPost(), errorClassification(), GET() (+24 more)
...
Cohesion: 0.09
Nodes (28): deprecateStepDefinitionAction(), deprecationReasonSchema, draftIdSchema, exactStepReferenceSchema, extensions, listStepDefinitionDraftsAction(), previewStepDefinitionDraftAction(), publishStepDefinitionDraftAction() (+20 more)

### Community 49 - "Community 49"
Cohesion: 0.17
Nodes (18): ensureProjectDatabaseUrl(), globalForPrisma, normalizeDatabaseUrl(), { PrismaClient }, PrismaClientInstance, readProjectDatabaseUrl(), require, checkLocatorGroupNameUnique() (+10 more)

### Community 50 - "Community 50"
Cohesion: 0.19
Nodes (13): deleteLocatorAction(), getAllLocatorsAction(), getLocatorByIdOrThrow(), listLocators(), ConflictResolutionSummary, getLocatorTableRows(), isLocatorGroupRow(), isLocatorTableRow() (+5 more)
...
Cohesion: 0.12
Nodes (24): ActiveProjectContext, ActiveProjectSelectionSource, detectPackageManager(), extractScripts(), fingerprintTargetProject(), isLocalTargetProject(), localCanonicalIdentity(), normalizeRemoteOrigin() (+16 more)
...
Cohesion: 0.12
Nodes (25): getQualityJourney(), submitDurableQualityJourneyCommand(), answerQualityJourneyAnalysisQuestionAction(), answerQuestionSchema, approveQualityJourneyAnalysisAction(), commentQualityJourneyScenarioPortfolioAction(), createJourneySchema, createQualityJourneyAction() (+17 more)
...
Cohesion: 0.13
Nodes (23): claimQualityJourneyWork(), completeQualityJourneyWork(), getQualityJourneyTriage(), prepareQualityJourneyTriage(), adapterFor(), clients, digest(), fixture() (+15 more)
...
Cohesion: 0.11
Nodes (11): CapsuleExecutorAdapter, runtimeCapsuleFilePathSchema, runtimeCapsuleHashSchema, runtimeCapsuleManifestEnvelopeSchema, runtimeCapsuleManifestSchemaInternal, runtimeCapsuleSegmentSchema, sealedStepDefinitionSchema, leaseDuration() (+3 more)
...
Cohesion: 0.12
Nodes (20): CommandMode, commandModeLabels, commandModePlaceholders, getCommandBadge(), getControlSection(), getExecutionSection(), getLibrarySection(), getNavigationCommandGroups() (+12 more)
...
Cohesion: 0.14
Nodes (14): AuthoredFlowItem, FlowBlock, TemplateTestCaseNodeOrderMap, FlowInvocationController, FlowInvocationEditor(), EMPTY_RESOURCES, LinearStepEditor(), LinearStepEditorProps (+6 more)
...
Cohesion: 0.17
Nodes (17): metadata, metadata, metadata, CreateTestSuite(), ModifyTestSuite(), deleteTestCaseAction(), getAllTestCasesAction(), deleteTestCasesByIds() (+9 more)
...
Cohesion: 0.10
Nodes (9): AutomationMaterializationStatus(), JourneyExecutionStatus(), ActiveAnalysis, ActiveProject, ActiveScenarioPortfolio, JourneyDetail, loadJourneyDetail(), loadJourneySupplementalArtifacts() (+1 more)
...
Cohesion: 0.10
Nodes (14): getRunningTestRunsCountAction(), getDashboardMetrics(), getEntityMetrics(), getRunningTestRunsCount(), getTestSuiteExecutionData(), { updateDashboardMetricsMock }, ActionResponse, ActionResponseData (+6 more)

### Community 91 - "Community 91"
Cohesion: 0.23
Nodes (4): hashRuntimeCapsuleValue(), RuntimeCapsuleManifest, RuntimeCapsuleRepository, collectAndValidateImports()
...
Cohesion: 0.12
Nodes (9): Portfolio, read(), Scenario, ScenarioDependency, scenarioFlow(), ScenarioMetadata(), ScenarioPortfolioReviewContent(), ScenarioReviewCallbacks (+1 more)
...
Cohesion: 0.13
Nodes (11): ReportScenarioWithDetails, TestCaseLogsModal(), TestCaseLogsModalProps, ReportScenarioWithDetails, ViewLogsButtonProps, ScrollArea(), ScrollBar(), StatusBadge() (+3 more)
...
Cohesion: 0.18
Nodes (13): collect(), exportQualityJourney(), getQualityJourneyLibraryArtifact(), listQualityJourneyArtifactLibrary(), normalizePage(), scopedJourney(), sortEntries(), cleanups (+5 more)
...
Cohesion: 0.21
Nodes (14): checkUniqueName(), createEnvironment(), createOrReplayEnvironment(), deleteEnvironments(), EnsuredEnvironment, ensureEnvironment(), environmentRegistryHash(), exactEnvironmentMatch() (+6 more)
...
Cohesion: 0.18
Nodes (13): canonicalTagExpression(), canonicalTagName(), TagShape, consumeCandidate(), extractTestCaseTitleFromScenarioName(), findMatchingTestRunTestCase(), MatchableRunTestCase, matchesIdentifier() (+5 more)

### Community 108 - "Community 108"
Cohesion: 0.18
Nodes (15): deleteTargetProjectAction(), deletionSchema, errorResponse(), registerTargetProjectAction(), registrationSchema, renameSchema, renameTargetProjectAction(), selectionSchema (+7 more)
...
Cohesion: 0.16
Nodes (12): cancelQualityJourneyWork(), dispatchQualityJourneyWork(), publicDispatchProjection(), recordAdapterSpawnReceipt(), releaseFailedDispatchReservation(), resumeQualityJourney(), revokeQualityJourneyWorkAuthorization(), completedResult() (+4 more)

### Community 116 - "Community 116"
Cohesion: 0.16
Nodes (7): ADD_NODE_PROMPT_NODE_TYPE, AddNodePromptNodeData, isAddNodePromptNode(), getFlowBlockBounds(), normalizeFlowBlocks(), PopulatedFlowCanvas(), FlowNodeSearchResult
...
Cohesion: 0.30
Nodes (11): AppSidebar(), ariaCurrent(), SidebarNavItem(), MobileNavigation(), MobileNavigationItem(), isNavigationItemActive(), ProjectNavigationProps, projectScopedHref() (+3 more)
...
Cohesion: 0.33
Nodes (8): json(), JsonRecord, listQualityJourneys(), object(), requirementSummary(), stringArray(), stringRecord(), mocks

### Community 139 - "Community 139"
Cohesion: 0.49
Nodes (8): coverageOutcome(), fail(), same(), validateCoverage(), validateFinding(), validateQualityJourneyTriageReport(), validateRemediation(), validFailedEvidence()
...
Cohesion: 0.29
Nodes (7): Action, JourneyExecutionCommand(), JourneyExecutionStartForm(), JourneyLiveRunRefresh(), JourneyRerunProposalForm(), mocks, Execution
...
Cohesion: 0.39
Nodes (8): assertFrozenResourceContent(), loadMaterializationReferences(), materializeAuthorizedScenarios(), materializeOne(), materializeSteps(), parseAndValidateScenarioIntent(), readyDefinitionIndex(), validateAuthorizedScenarios()
...
Cohesion: 0.32
Nodes (7): QualityJourneyDetailPage(), analysisRevision(), digest(), journey(), mocks, project, renderPage()
...
## Knowledge Gaps
- **1046 isolated node(s):** `startLocatorPickerSessionSchema`, `mocks`, `mocks`, `cookieStore`, `metadata` (+1041 more)
...
- **Why does `ServiceError` connect `Community 38` to `Community 0`, `Community 131`, `Community 7`, `Community 139`, `Community 12`, `Community 14`, `Community 15`, `Community 143`, `Community 19`, `Community 21`, `Community 152`, `Community 24`, `Community 26`, `Community 28`, `Community 29`, `Community 156`, `Community 157`, `Community 37`, `Community 39`, `Community 40`, `Community 42`, `Community 44`, `Community 45`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 62`, `Community 65`, `Community 68`, `Community 78`, `Community 80`, `Community 82`, `Community 84`, `Community 87`, `Community 97`, `Community 102`, `Community 105`, `Community 108`, `Community 117`, `Community 119`, `Community 124`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.308) - this node is a cross-community bridge._
- **Why does `ActionResponse` connect `Community 90` to `Community 2`, `Community 3`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 30`, `Community 38`, `Community 42`, `Community 48`, `Community 49`, `Community 50`, `Community 58`, `Community 59`, `Community 66`, `Community 78`, `Community 108`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `canonicalContractJson()` connect `Community 145` to `Community 97`, `Community 98`, `Community 51`, `Community 143`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.04493284493284493 - nodes in this community are weakly interconnected._
