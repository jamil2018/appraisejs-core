...
## Summary
- 2959 nodes · 8204 edges · 116 communities (108 shown, 8 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f43c72bc`
...
Cohesion: 0.07
Nodes (67): payload, templateStepGroupSchema, testCaseSchema, generateUniqueTestCaseIdentifier(), deleteLocatorAction(), getLocatorByIdAction(), deleteLocators(), getLocatorByIdOrThrow() (+59 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (58): getPageTransitionVariant(), PageTransitionVariant, Template(), { usePathnameMock }, TestRunDetailPage(), MotionDivProps, motionReactMVitestMock, motionReactVitestMock (+50 more)
...
Cohesion: 0.06
Nodes (44): TestRun, testRunFormOpts, getFilterTags(), TagShape, getActionErrorMessage(), getTestRunSuccessPath(), isModuleRow(), isTestSuitePickerRow() (+36 more)
...
Cohesion: 0.08
Nodes (40): buildStepKeywords(), getStepSearchScore(), normalizeForSearch(), scoreMatch(), StepIcon(), TemplateStepCombobox(), TemplateStepComboboxProps, EmptyTube() (+32 more)
...
Cohesion: 0.12
Nodes (42): metadata, metadata, metadata, metadata, getTemplateTestCasesWithSteps(), CreateTestCaseFromTemplate(), metadata, {
...
Cohesion: 0.09
Nodes (37): metadata, InfoCards, TestSuite, testSuiteFormOpts, testSuiteSchema, InlineTestSuiteCreationDialogProps, getEditableTestSuite(), isEditableTestSuite() (+29 more)
...
Cohesion: 0.09
Nodes (37): metadata, metadata, metadata, metadata, CreateTestRun(), CreateTestSuite(), tagSchema, ModifyTag() (+29 more)

### Community 13 - "Community 13"
Cohesion: 0.11
Nodes (32): metadata, metadata, CreateModule(), Module, moduleSchema, ModifyModule(), createModule(), deleteModules() (+24 more)
...
Cohesion: 0.08
Nodes (27): metadata, ButtonSkeleton(), IconButtonSkeleton(), TemplateStepGroup, templateStepGroupFormOpts, TemplateStepGroupType, TemplateStepGroupTypeEnum, TextInputSkeleton() (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (27): metadata, AppDrawerItem, AppDrawerItemColor, DataCard(), DataCardGrid(), colorMap, ExecutionHealthPanel(), ExecutionHealthPanelProps (+19 more)
...
Cohesion: 0.11
Nodes (33): metadata, CreateTemplateStep(), TemplateStep, templateStepFormOpts, templateStepSchema, ModifyTemplateStepPage(), ParamChip(), buildFunctionDefinitionPreview() (+25 more)
...
Cohesion: 0.11
Nodes (32): Dashboard(), getDashboardMetricsAction(), getEntityMetricsAction(), getRunningTestRunsCountAction(), getTestSuiteExecutionDataAction(), getDashboardMetrics(), getEntityMetrics(), getRunningTestRunsCount() (+24 more)
...
Cohesion: 0.08
Nodes (25): coordinatorContractVersion, getProviderWorkflowRun(), listProviderWorkflowRuns(), createPlanArtifactSchema, createPlanBodySchema, dispatchGet(), dispatchPost(), GET() (+17 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (26): CommandBadgeProps, listPlans(), getStatusStyle(), PlanFlowTaskNode, statusStyles, metadata, PlansPage(), approvedStates (+18 more)
...
Cohesion: 0.09
Nodes (23): flowBlockSchema, testCaseStepSchema, testCaseStepsSchema, formatOrderedGherkinSteps(), EMPTY_FLOW_BLOCKS, TemplateTestCaseForm(), TemplateTestCaseFormProps, { push, toast } (+15 more)
...
Cohesion: 0.09
Nodes (17): BaseNode(), AddNodePromptNodeComponentProps, FlowDiagramNodeSearch(), FlowDiagramNodeSearchProps, FlowNodeSearchResult, FlowDiagramToolbarProps, OptionsHeaderGherkinParameter, OptionsHeaderGherkinStep() (+9 more)

### Community 36 - "Community 36"
Cohesion: 0.10
Nodes (27): testRunSchema, resolveTargetProject(), formatLogsForStorage(), LogEntry, parseLogsFromStorage(), buildOrExpression(), buildTestRunsWhereClause(), isCancelledOrCancellingStatus() (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (29): appendProviderEvent(), appendProviderEvents(), createProviderWorkflowRun(), ensureAdapterRegistration(), execFileAsync, hashText(), isLaunchableRegistration(), JsonRecord (+21 more)
...
Cohesion: 0.24
Nodes (11): formatDateTime(), locatorGroupTableCols, tagTableCols, templateTestCaseTableCols, testCasesMetricTableCols, BrowserEngineIcon, testSuitesMetricTableCols, Checkbox() (+3 more)
...
Cohesion: 0.13
Nodes (15): metadata, { push, refresh, toast, startLocatorPickerSessionAction, savePickedLocatorAction }, TestRunDetailPageProps, DownloadLogsButton(), DownloadLogsButtonProps, LogViewer(), LogViewerProps, { getTestRunLogsAction } (+7 more)
...
Cohesion: 0.19
Nodes (23): getAutomationConfigDir(), getAutomationEnvironmentsDir(), getAutomationMappingDir(), getAutomationReportLogsDir(), getAutomationReportRunDir(), getAutomationReportsDir(), getAutomationRoot(), getAutomationRunLogPath() (+15 more)
...
Cohesion: 0.21
Nodes (14): ensureProjectDatabaseUrl(), globalForPrisma, normalizeDatabaseUrl(), { PrismaClient }, PrismaClientInstance, readProjectDatabaseUrl(), require, getIdentifierTagByPrefix() (+6 more)
...
Cohesion: 0.16
Nodes (15): CommandMode, commandModeLabels, commandModePlaceholders, getCommandBadge(), NavigationCommandGroup, navigationCommandGroups, NavigationCommandItem, SearchCommandItem (+7 more)
...
Cohesion: 0.13
Nodes (10): ReportTestCaseWithRelations, reportViewTableCols, ReportScenarioWithDetails, TestCaseLogsModal(), TestCaseLogsModalProps, ReportScenarioWithDetails, ViewLogsButton(), ViewLogsButtonProps (+2 more)
...
Cohesion: 0.23
Nodes (10): cancelProviderWorkflowRun(), recordProviderPermissionDecision(), postProviderRun(), cancelProviderRunAction(), cancelProviderRunSchema, createProviderRunAction(), createProviderRunSchema, decideProviderPermissionAction() (+2 more)
...
Cohesion: 0.24
Nodes (6): formatDate(), ProviderRunWorkspace(), ProviderRunWorkspaceProps, RunCard(), RunWithRelations, statusStyles
...
Cohesion: 0.24
Nodes (7): { push, toast, checkTestRunNameUniqueAction }, TestRunFieldErrorsProps, TestRunForm(), TestRunFormProps, useTestRunNameValidation(), RadioGroup(), RadioGroupItem()

### Community 93 - "Community 93"
Cohesion: 0.24
Nodes (5): ensureProviderRegistrations(), listProviderAdapters(), listProviderRegistrations(), metadata, SettingsPage()
...
## Knowledge Gaps
- **538 isolated node(s):** `startLocatorPickerSessionSchema`, `payload`, `InvalidSyncExecutionResult`, `metadata`, `{ push, toast }` (+533 more)
...
- **Why does `ServiceError` connect `Community 0` to `Community 6`, `Community 12`, `Community 13`, `Community 15`, `Community 20`, `Community 22`, `Community 25`, `Community 28`, `Community 32`, `Community 36`, `Community 37`, `Community 45`, `Community 52`, `Community 55`, `Community 56`, `Community 57`, `Community 61`, `Community 64`, `Community 66`, `Community 68`, `Community 75`, `Community 95`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 29`, `Community 31`, `Community 35`, `Community 40`, `Community 46`, `Community 47`, `Community 50`, `Community 58`, `Community 63`, `Community 67`, `Community 80`, `Community 92`, `Community 104`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 17` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 16`, `Community 18`, `Community 19`, `Community 22`, `Community 29`, `Community 31`, `Community 35`, `Community 42`, `Community 46`, `Community 47`, `Community 50`, `Community 58`, `Community 63`, `Community 67`, `Community 70`, `Community 71`, `Community 78`, `Community 90`, `Community 92`, `Community 95`, `Community 104`?**
